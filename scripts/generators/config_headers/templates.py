...
# Hard-coded data
# ============================================================================
# The token -> font-pointer mapping for LV_FONT_DEFAULT: the `&lv_font_*`
# pointers are C symbols, not config values.  LV_FONT_DEFAULT carries the
# *token* on both build paths
