...
:Note: a file system driver needs to be registered to open images from 
       files. Read more about it :ref:`overview/fs/file system` or just
...
As it might take significant time to decode PNG images LVGL's :ref:`overview/image/image caching` feature can be useful.
