...
Visit :ref:`Input devices <overview/indev/input devices>` to learn more about input
devices in general.
...
- :ref:`Indev features <overview/indev/input devices>` to learn more about higher level input device features.
