---
title: "Developer Certification of Origin (DCO)"
description: "To ensure all licensing criteria are met for every repository of the LVGL project, we apply a process called DCO (Developer's Certificate of Origin)."
---
