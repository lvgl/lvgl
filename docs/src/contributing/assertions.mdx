...
each within LVGL's codebase. If you are using LVGL rather than contributing to
it, see [Argument Checking](/debugging/argument_checking) for what these checks
mean for your application and how to configure them.
...
<ApiLink name="LV_CHECK_OBJ" /> is the only object-checking macro you should use
directly, and the replacement for the removed `LV_ASSERT_OBJ`. It performs all checks
