...
# further.  For a list of options available for each theme, see the theme
# documentation.
#
# Various other builders are derived from the HTML output, and also make use of these options.
...
# -- Modification to HTML builder configuration ---------------------------
