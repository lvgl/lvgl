...
project = 'LVGL Pro\ |reg|'
copyright = '2025-%Y, LVGL Kft'
author = 'LVGL Kft'
version = '0.3.0'
release = version
...
# |version| and |release|, which can be used anywhere in the doc source files.
...
html_theme_options = {
    ...
    "source_repository": "https://github.com/lvgl/lvgl_editor/",
...
html_baseurl = f"https://editor_docs.lvgl.io/{_branch}/"
...
htmlhelp_basename = 'LVGL_Pro_doc'
...
latex_documents = [
    (master_doc, 'LVGL_Pro.tex', 'LVGL Pro v' + version,
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'lvgl_pro', 'LVGL Pro v' + version,
     [author], 3)
]
