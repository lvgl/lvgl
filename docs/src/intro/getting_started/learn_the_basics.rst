...
.. _basic_integration_steps:

Basic LVGL Integration Steps
----------------------------
...
3. **Create display and input devices**: Create display(s)
   (:cpp:type:`lv_display_t`) and input device(s)  (:cpp:type:`lv_indev_t`) and set up
   their callbacks
