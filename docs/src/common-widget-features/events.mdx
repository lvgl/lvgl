...
- <ApiLink name="LV_EVENT_GESTURE_UP" />: An upwards gesture is detected. Sent right after <ApiLink name="LV_EVENT_GESTURE" />
- <ApiLink name="LV_EVENT_GESTURE_DOWN" />: A downwards gesture is detected. Sent right after <ApiLink name="LV_EVENT_GESTURE" />
- <ApiLink name="LV_EVENT_GESTURE_LEFT" />: A leftwards gesture is detected. Sent right after <ApiLink name="LV_EVENT_GESTURE" />
- <ApiLink name="LV_EVENT_GESTURE_RIGHT" />: A rightwards gesture is detected. Sent right after <ApiLink name="LV_EVENT_GESTURE" />
...
- <ApiLink name="LV_EVENT_KEY_PRESSED" />: A key has been pressed.
- <ApiLink name="LV_EVENT_KEY_SHORT_CLICKED" />: A key was pressed for less than `long_press_time`, then released.
- <ApiLink name="LV_EVENT_KEY_LONG_CLICKED" />: A key was pressed for at least `long_press_time`, then released.
- <ApiLink name="LV_EVENT_KEY_LONG_PRESSED" />: A key has been pressed for at least `long_press_time`.
- <ApiLink name="LV_EVENT_KEY_LONG_PRESSED_REPEAT" />: Sent after `long_press_time` in every `long_press_repeat_time` ms while a key is pressed.
- <ApiLink name="LV_EVENT_KEY_CLICKED" />: A key was pressed, then released, after either a short or a long press.
- <ApiLink name="LV_EVENT_KEY_RELEASED" />: A key has been released.
...
- <ApiLink name="LV_EVENT_CHECKED" />: A checkable Widget became checked. Sent right after <ApiLink name="LV_EVENT_VALUE_CHANGED" />
- <ApiLink name="LV_EVENT_UNCHECKED" />: A checkable Widget became unchecked. Sent right after <ApiLink name="LV_EVENT_VALUE_CHANGED" />
