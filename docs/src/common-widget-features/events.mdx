...
If <ApiLink name="lv_obj_set_event_bubble" display="lv_obj_set_event_bubble(widget, true)" /> is enabled all
...
Also known as Event Capturing, if <ApiLink name="lv_obj_set_event_trickle" display="lv_obj_set_event_trickle(widget, true)" />
