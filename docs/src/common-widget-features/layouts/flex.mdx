...
<LvglXMLExample name="lv_example_flex_flow" path="layouts/flex/flex_flow/lv_example_flex_flow" />
...
<LvglXMLExample name="lv_example_flex_align" path="layouts/flex/flex_align/lv_example_flex_align" />
...
<LvglXMLExample name="lv_example_flex_grow" path="layouts/flex/flex_grow/lv_example_flex_grow" />
...
<LvglXMLExample name="lv_example_flex_internal_padding" path="layouts/flex/flex_internal_padding/lv_example_flex_internal_padding" />
...
<LvglXMLExample name="lv_example_flex_rtl" path="layouts/flex/flex_rtl/lv_example_flex_rtl" />
...
<LvglXMLExample name="lv_example_flex_new_track" path="layouts/flex/flex_new_track/lv_example_flex_new_track" />
...
<LvglXMLExample name="lv_example_flex_ignore_layout" path="layouts/flex/flex_ignore_layout/lv_example_flex_ignore_layout" />
...
### Flex align: main and cross axis placement
...
### Internal padding: gap between flex items
...
### New track: force items onto a new flex row
...
### Ignore layout: opt out of flex positioning
