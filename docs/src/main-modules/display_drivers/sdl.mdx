---
title: SDL
description: "SDL (Simple DirectMedia Layer) provides a cross-platform way to handle graphics, input, and multimedia, making it an excellent choice for running LVGL applications on a PC."
---

## Overview

[SDL](https://www.libsdl.org/) (Simple DirectMedia Layer) provides a cross-platform way to handle graphics,
...
No additional configuration needed - this is the default when only <ApiLink name="LV_USE_SDL" /> is enabled.
...
For complete details, see [SDL Draw Unit](/main-modules/renderers/sdl).
...
- [NanoVG Draw Unit](/main-modules/renderers/nanovg)
- [OpenGL Draw Unit](/main-modules/renderers/opengles)
...
- [SDL Draw Unit](/main-modules/renderers/sdl) - SDL texture-based rendering
- [OpenGL Overview](/integration/embedded_linux/opengl) - Complete OpenGL integration overview
- [NanoVG Draw Unit](/main-modules/renderers/nanovg) - NanoVG vector graphics rendering
- [OpenGL ES Draw Unit](/main-modules/renderers/opengles) - OpenGL ES for embedded systems
