...
[DRM](/main-modules/display_drivers/drm) or [Wayland](/main-modules/display_drivers/wayland).
...
- [Wayland](/main-modules/display_drivers/wayland) - the modern alternative on Linux desktops
- [SDL Driver](/main-modules/display_drivers/sdl) - cross-platform alternative for development
- [GLFW](/main-modules/display_drivers/glfw) - development driver with an OpenGL context
- [DRM](/main-modules/display_drivers/drm) - production alternative with no display server
