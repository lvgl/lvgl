...
[DRM/KMS](/main-modules/display_drivers/drm), which supersedes fbdev and can reach the GPU.
...
| Input | None built in. Pair with [evdev](/main-modules/input_drivers/evdev) or [libinput](/main-modules/input_drivers/libinput) |

## See Also

- [DRM](/main-modules/display_drivers/drm) - the modern replacement, with modesetting and a GPU path
- [evdev](/main-modules/input_drivers/evdev) - simplest input pairing for this driver
- [libinput](/main-modules/input_drivers/libinput) - input with device quirks and full keyboard support
