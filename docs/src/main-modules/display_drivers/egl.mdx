...
- [DRM](/main-modules/display_drivers/drm) with `LV_LINUX_DRM_BACKEND_EGL`
- [Wayland](/main-modules/display_drivers/wayland) with `LV_WAYLAND_BACKEND_EGL`
- [SDL](/main-modules/display_drivers/sdl) with `LV_SDL_BACKEND_EGL`
...
EGL during setup. See [DRM](/main-modules/display_drivers/drm) or
[Wayland](/main-modules/display_drivers/wayland) for working examples.

## See Also

- [DRM](/main-modules/display_drivers/drm) - EGL backend for direct-to-display rendering
- [Wayland](/main-modules/display_drivers/wayland) - EGL backend under a compositor
- [OpenGL Driver](/main-modules/display_drivers/opengl_texture) - use when you already own the context
- [OpenGL Overview](/integration/embedded_linux/opengl) - how the drivers and draw units fit together
- [NanoVG Draw Unit](/main-modules/renderers/nanovg) - the renderer used for off-screen rendering
