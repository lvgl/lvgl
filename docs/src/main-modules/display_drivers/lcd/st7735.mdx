...
platform-agnostic driver, based on the [generic MIPI driver](/main-modules/display_drivers/lcd/gen_mipi).  It implements
...
[generic MIPI driver](/main-modules/display_drivers/lcd/gen_mipi) documentation.
