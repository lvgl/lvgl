...
- [GLFW](/main-modules/display_drivers/glfw) on PC-like platforms
- [EGL](/main-modules/display_drivers/egl), or [DRM](/main-modules/display_drivers/drm) and
  [Wayland](/main-modules/display_drivers/wayland) with their EGL backends, on embedded targets
- [SDL](/main-modules/display_drivers/sdl) with its EGL backend
...
- [GLFW](/main-modules/display_drivers/glfw) - creates the window and context for you, and can composite these textures
- [EGL](/main-modules/display_drivers/egl) - context creation on embedded targets, including off-screen rendering
- [OpenGL Overview](/integration/embedded_linux/opengl) - how the drivers and draw units fit together
- [NanoVG Draw Unit](/main-modules/renderers/nanovg) - the recommended GPU renderer
- [OpenGL ES Draw Unit](/main-modules/renderers/opengles) - the texture-caching renderer
