...
[OpenGL Driver](/main-modules/display_drivers/opengl_texture) for the texture-only driver, which
...
- [EGL](/main-modules/display_drivers/egl) - use instead of GLFW when you need EGL
