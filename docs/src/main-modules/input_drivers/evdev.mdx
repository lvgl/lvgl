...
[framebuffer](/main-modules/display_drivers/fbdev) and [DRM](/main-modules/display_drivers/drm)
...
| Full keyboard (layouts, modifiers) | No — use [libinput](/main-modules/input_drivers/libinput) with XKB |
...
- [libinput](/main-modules/input_drivers/libinput) - richer input stack, with XKB keyboard support
- [Linux Framebuffer](/main-modules/display_drivers/fbdev) - display driver commonly paired with evdev
- [DRM](/main-modules/display_drivers/drm) - display driver commonly paired with evdev
