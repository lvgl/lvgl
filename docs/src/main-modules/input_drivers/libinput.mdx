...
Compared with [evdev](/main-modules/input_drivers/evdev), libinput gives you two things that matter:
...
Use [evdev](/main-modules/input_drivers/evdev) for a minimal system with a known touchscreen;
...
- [evdev](/main-modules/input_drivers/evdev) - lighter alternative, with discovery and hotplug
- [Linux Framebuffer](/main-modules/display_drivers/fbdev) - display driver needing a separate input driver
- [DRM](/main-modules/display_drivers/drm) - display driver needing a separate input driver
