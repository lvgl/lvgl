---
title: Keypad and Keyboard
description: Full keyboards with all the letters or simple keypads with a few navigation buttons belong in the Keypad category.
---
...
- <ApiLink name="LV_KEY_NEXT" />: Move focus to the next object
- <ApiLink name="LV_KEY_PREV" />: Move focus to the previous object
- <ApiLink name="LV_KEY_ENTER" />: Triggers <ApiLink name="LV_EVENT_PRESSED" />,
  <ApiLink name="LV_EVENT_CLICKED" />, or <ApiLink name="LV_EVENT_LONG_PRESSED" />
  events
- <ApiLink name="LV_KEY_UP" />: Increase value or move up
- <ApiLink name="LV_KEY_DOWN" />: Decrease value or move down
- <ApiLink name="LV_KEY_RIGHT" />: Increase value or move to the right
- <ApiLink name="LV_KEY_LEFT" />: Decrease value or move to the left
- <ApiLink name="LV_KEY_ESC" />: Close or exit (e.g., close a [Drop-Down List](/widgets/dropdown))
- <ApiLink name="LV_KEY_DEL" />: Delete (e.g., a character on the right in a
  [Text Area](/widgets/textarea))
- <ApiLink name="LV_KEY_BACKSPACE" />: Delete (e.g., a character on the left in a
  [Text Area](/widgets/textarea))
- <ApiLink name="LV_KEY_HOME" />: Go to the beginning/top (e.g., in a
  [Text Area](/widgets/textarea))
- <ApiLink name="LV_KEY_END" />: Go to the end (e.g., in a
  [Text Area](/widgets/textarea))

The most important special keys in your <ApiLink name="read_cb" /> function are:

- <ApiLink name="LV_KEY_NEXT" />
- <ApiLink name="LV_KEY_PREV" />
- <ApiLink name="LV_KEY_ENTER" />
- <ApiLink name="LV_KEY_UP" />
- <ApiLink name="LV_KEY_DOWN" />
- <ApiLink name="LV_KEY_LEFT" />
- <ApiLink name="LV_KEY_RIGHT" />
...
you can get their value by querying <ApiLink name="lv_evdev_get_raw_key" /> in a `LV_EVENT_KEY handler.

Also the event callback needs to check for <ApiLink name="lv_evdev_is_raw_key" /> before calling <ApiLink name="lv_evdev_get_raw_key" />.
...
<ApiLink name="lv_indev_set_key_remap_cb" /> to enable it.
