...
you can get their value by querying lv_evdev_get_raw_key in a LV_EVENT_KEY handler.

Also the event callback needs to check for lv_evdev_is_raw_key before calling lv_evdev_get_raw_key
