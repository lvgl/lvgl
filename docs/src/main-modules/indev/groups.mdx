---
title: Groups
description: "Groups are a \"group of widgets\" that can be focused by Keypad or Encoder input devices."
---
...
`lv_slider.c](https://github.com/lvgl/lvgl/blob/master/src/widgets/slider/lv_slider.c).
