---
title: Color Formats
description: "The following image pixel color formats have built-in decoding support:"
---
...
| RAW_ALPHA [^2] | ? | n/a | See [Custom Image Formats](/main-modules/images/decoders) |
...
| NATIVE_WITH_ALPHA [^3] | Depends | No | The alpha-capable companion of <ApiLink name="LV_COLOR_FORMAT_DEFAULT" /> |
