...
void my_flush_cb(lv_display_t * display, const lv_area_t * area, uint8_t * px_map)
{
    ...
    /* if using a monochrome display (LV_COLOR_FORMAT_I1), make sure to skip the palette! (https://docs.lvgl.io/master/main-modules/display/color_format.html#monochrome-displays) */
    int32_t x, y;
