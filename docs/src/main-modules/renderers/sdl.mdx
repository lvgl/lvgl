...
For genuinely GPU-accelerated rendering, use [NanoVG](/main-modules/renderers/nanovg)
...
- [SDL Driver](/main-modules/display_drivers/sdl) - the display driver this draw unit pairs with
- [NanoVG Draw Unit](/main-modules/renderers/nanovg) - true GPU rasterization, via SDL's EGL backend
