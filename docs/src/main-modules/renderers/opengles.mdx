...
[NanoVG](/main-modules/renderers/nanovg) is the recommended GPU renderer on Linux: it
...
[NanoVG](/main-modules/renderers/nanovg) has none of these limitations.
...
- [OpenGL Driver](/main-modules/display_drivers/opengl_texture) - texture-only driver for an existing context
- [EGL](/main-modules/display_drivers/egl) - context creation on embedded targets
