...
- Update system-monitor values. If <ApiLink name="LV_USE_SYSMON" /> is enabled, one or more timers are created
  to periodically compute and monitor system performance statistics and LVGL's memory usage.
