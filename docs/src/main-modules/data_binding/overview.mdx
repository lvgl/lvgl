...
When the subjects are no longer needed they can be deleted or deinitialized:
```c
/*If it was created with lv_subject_create()*/
lv_subject_delete(subject_1);

/*If it was initialized with lv_subject_init_...()*/
