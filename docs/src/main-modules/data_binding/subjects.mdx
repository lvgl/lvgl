...
The remaining types work the same way with <ApiLink name="lv_subject_init_float" display="lv_subject_init_float()" />,
...
Every type also has a `lv_subject_get_previous_...()` function (e.g.
...
- <ApiLink name="lv_obj_add_subject_increment_event" display="lv_obj_add_subject_increment_event(obj, &subject, trigger, step)" />
  ...
  descriptor you can bound further with
  <ApiLink name="lv_obj_set_subject_increment_event_min_value" display="lv_obj_set_subject_increment_event__min_value()" />,
  <ApiLink name="lv_obj_set_subject_increment_event_max_value" display="lv_obj_set_subject_increment_event__max_value()" /> and
  <ApiLink name="lv_obj_set_subject_increment_event_rollover" display="lv_obj_set_subject_increment_event__rollover()" />.
...
These events stay attached to the Widget and are **not** removed when the Subject is
de-initialized.
