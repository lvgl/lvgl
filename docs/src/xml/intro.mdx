---
title: Introduction
description: "LVGL Pro is a complete toolkit to build, test, share, and ship embedded UIs efficiently."
---
...
- **An XML Editor** with powerful autocomplete features to describe UI components,
  ...
  about [XML](/xml/xml/overview) and the [Editor](/xml/editor/overview).
- **Online Share** is an online version of the Editor which can load the XML files from
  ...
  development environments. Learn more [here](/xml/tools/online_share).
...
- **Figma Plugin** that allows you to extract the style properties from Figma elements
  and also synchronize them in the Editor or with the CLI. Learn more [here](/xml/tools/figma).
