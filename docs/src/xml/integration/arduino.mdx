---
title: Arduino IDE
description: "This guide explains how to properly integrate your LVGL Editor exported project into an Arduino sketch, why it must go inside the src folder, and how to fix include paths for successful compilation."
---
...
The <ApiLink name="LV_LVGL_H_INCLUDE_SIMPLE" /> define controls how LVGL headers are included.
...
To ensure correct compilation, you need to instruct the Arduino build system to define <ApiLink name="LV_LVGL_H_INCLUDE_SIMPLE" /> during compilation.
...
1. Copy or create the LVGL Editor Project inside `src` folder
2. Update Includes
...
1. Reapply Changes After Regeneration
