---
title: Animations
description: XML animations are built on top of Timeline animations.
---

## Overview

XML animations are built on top of [Timeline animations](/main-modules/animation).
...
to pointers by using <ApiLink name="lv_obj_find_by_name" />.
