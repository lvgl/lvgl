...
- [&lt;api>](/xml/ui_elements/api): Screens are always created as they are, with no parameters.
- [&lt;preview>](/xml/ui_elements/preview): In LVGL's UI Editor, `<preview>` is used to set the style, size, and other parameters of the previewing "screen". For Screens, the
...
Screens don't support the [&lt;preview>](/xml/ui_elements/preview) tag because it doesn't make
