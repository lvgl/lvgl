---
title: Events in XML
description: There are several ways to define events for user interactions. These events can be added as children of any widget.
---
...
- <ApiLink name="LV_EVENT_ALL" />: `"all"`
- <ApiLink name="LV_EVENT_CLICKED" />: `"clicked"`
- <ApiLink name="LV_EVENT_PRESSED" />: `"pressed"`
- etc.
...
<ApiLink name="lv_xml_register_event_cb" display="lv_xml_register_event_cb(&quot;my_callback_1&quot;, an_event_handler)" />.
...
It's possible to set a [Subject](/main-modules/observer/observer) value on user interaction by adding a special child to any widget:
...
Incrementing or decrementing a [Subject](/main-modules/observer/observer) value can be defined as follows:
