...
figma-to-lvgl) plugin displays the style properties of selected UI elements in
Figma.
...
<Figure
  src="/_static/images/figma_to_lvgl_menu.png"
...
<Figure
  src="/_static/images/figma_to_lvgl_plugin.png"
...
| Field | Description |
|-------|-------------|
| `XXXXXX` | is the string after "design" in the Figma URL. For example, if the Figma URL is `https://www.figma.com/design/P8NM0qOqgWfYpbENhAKqYb`, then XXXXXX would be "P8NM0qOqgWfYpbENhAKqYb". |
| `YYYYY` | is the Personal Access Token that you can generate as described in the [Manage Personal Access Tokens](https://help.figma.com/hc/en-us/articles/ 8085703771159-Manage-personal-access-tokens) article in Figma documentation. |
...
The [CLI tool](/xml/tools/cli) can also synchronize styles from Figma in CI/CD:
