---
title: "Data binding (Subjects)"
description: "With the help of Subjects, the interface of the UI can be created."
---

## Overview

With the help of [Subjects](/main-modules/observer/observer), the interface of the UI can be created.
...
Learn more about these in [Set Subject Value](/xml/ui_elements/events) and
[Increment Subject Value](/xml/ui_elements/events).
