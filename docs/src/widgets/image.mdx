...
<LvglXMLExample name="lv_example_image_src" path="widgets/image/image_src/lv_example_image_src" />
...
SVG sources can also be set (with `LV_USE_SVG` enabled). This C example
loads an SVG into the same `lv_image` widget and applies both widget-level
transforms (`lv_image_set_scale`, `lv_image_set_rotation`) and style-based
transforms — handy for icons that need to stay sharp at any size:
...
<LvglXMLExample name="lv_example_image_recolor" path="widgets/image/image_recolor/lv_example_image_recolor" />
...
<LvglXMLExample name="lv_example_image_transformations" path="widgets/image/image_transformations/lv_example_image_transformations" />
...
<LvglXMLExample name="lv_example_image_inner_align" path="widgets/image/image_inner_align/lv_example_image_inner_align" />
