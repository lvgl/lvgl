...
The Spangroup Widget is used to display rich text. Unlike a Label, each Span within
a Spangroup has its own text, font, color, and size. Spans can be added and removed
at any time.
...
<LvglXMLExample name="lv_example_span_styling" path="widgets/span/span_styling/lv_example_span_styling" />
