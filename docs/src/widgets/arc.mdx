...
<LvglXMLExample name="lv_example_arc_value_range" path="widgets/arc/arc_value_range/lv_example_arc_value_range" />
...
<LvglXMLExample name="lv_example_arc_rotation" path="widgets/arc/arc_rotation/lv_example_arc_rotation" />
...
<LvglXMLExample name="lv_example_arc_mode" path="widgets/arc/arc_mode/lv_example_arc_mode" />
...
<LvglXMLExample name="lv_example_arc_change_rate" path="widgets/arc/arc_change_rate/lv_example_arc_change_rate" />
...
<LvglXMLExample name="lv_example_arc_styling" path="widgets/arc/arc_styling/lv_example_arc_styling" />
...
<LvglXMLExample name="lv_example_arc_set_angles" path="widgets/arc/arc_set_angles/lv_example_arc_set_angles" />
...
<LvglXMLExample name="lv_example_arc_pie_chart" path="widgets/arc/arc_pie_chart/lv_example_arc_pie_chart" />
...
`arc_width` on `LV_PART_INDICATOR` that is large enough to reach the centre
— this turns the band into a solid wedge. Hide the bg track and the knob
(opacity 0 on `LV_PART_MAIN` and `LV_PART_KNOB`) so nothing else is drawn.
...
<LvglXMLExample name="lv_example_arc_bind_value" path="widgets/arc/arc_bind_value/lv_example_arc_bind_value" />
