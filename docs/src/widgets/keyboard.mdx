...
<LvglXMLExample name="lv_example_keyboard_modes" path="widgets/keyboard/keyboard_modes/lv_example_keyboard_modes" />
...
<LvglXMLExample name="lv_example_keyboard_textarea" path="widgets/keyboard/keyboard_textarea/lv_example_keyboard_textarea" />
...
<LvglXMLExample name="lv_example_keyboard_popovers" path="widgets/keyboard/keyboard_popovers/lv_example_keyboard_popovers" />
...
This C example replaces the default text keymap with an AZERTY layout
(both the visible keys and the per-key control flags), demonstrating the
shape of the two arrays passed to `lv_keyboard_set_map`:
