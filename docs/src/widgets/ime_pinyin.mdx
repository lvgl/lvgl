---
title: Pinyin IME
description: "Chinese Pinyin input method for the Keyboard widget. Supports 26-key and 9-key input modes."
---

Pinyin IME adds a Chinese Pinyin input method to the
[Keyboard](/widgets/keyboard) widget. It supports both 26-key and 9-key
input modes. Think of `lv_ime_pinyin` as a Pinyin plug-in for the
Keyboard.

Any environment that can run the Keyboard widget can also run
`lv_ime_pinyin`. The two main constraints are the size of the font file
