...
<LvglExample name="lv_example_button_basic" path="widgets/button/button_basic/lv_example_button_basic" />
...
<LvglExample name="lv_example_button_states" path="widgets/button/button_states/lv_example_button_states" />
...
<LvglExample name="lv_example_button_styling" path="widgets/button/button_styling/lv_example_button_styling" />
