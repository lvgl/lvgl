...
assigning the subject toggles the box. Pair it with
<ApiLink name="lv_obj_bind_bool" /> on other widgets to react to that flag
without writing any event callback.
