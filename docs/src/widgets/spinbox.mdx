...
<LvglXMLExample name="lv_example_spinbox_value" path="widgets/spinbox/spinbox_value/lv_example_spinbox_value" />
...
<LvglXMLExample name="lv_example_spinbox_format" path="widgets/spinbox/spinbox_format/lv_example_spinbox_format" />
...
<LvglXMLExample name="lv_example_spinbox_rollover" path="widgets/spinbox/spinbox_rollover/lv_example_spinbox_rollover" />
...
<LvglXMLExample name="lv_example_spinbox_styling" path="widgets/spinbox/spinbox_styling/lv_example_spinbox_styling" />
...
<LvglXMLExample name="lv_example_spinbox_bind_value" path="widgets/spinbox/spinbox_bind_value/lv_example_spinbox_bind_value" />
...
`LV_EVENT_SHORT_CLICKED` and `LV_EVENT_LONG_PRESSED_REPEAT`. This C example
...
`lv_spinbox_increment`/`_decrement`.
