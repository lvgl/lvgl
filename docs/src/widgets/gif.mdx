---
title: "GIF (lv_gif)"
description: "The GIF Widget displays animated GIF images using the AnimatedGIF decoder library."
---

## Overview

The GIF Widget displays animated GIF images using the
[AnimatedGIF](https://github.com/bitbank2/AnimatedGIF/tree/master) library.
Enable it in `lv_conf.h` by setting <ApiLink name="LV_USE_GIF" /> to `1`.
...
- <ApiLink name="LV_EVENT_READY" /> Emitted when the animation completes its last frame.
