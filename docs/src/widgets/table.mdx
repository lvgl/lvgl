...
<LvglXMLExample name="lv_example_table_cells" path="widgets/table/table_cells/lv_example_table_cells" />
...
<LvglXMLExample name="lv_example_table_rows_columns" path="widgets/table/table_rows_columns/lv_example_table_rows_columns" />
...
<LvglXMLExample name="lv_example_table_width" path="widgets/table/table_width/lv_example_table_width" />
...
<LvglXMLExample name="lv_example_table_merge_cells" path="widgets/table/table_merge_cells/lv_example_table_merge_cells" />
...
<LvglXMLExample name="lv_example_table_styling" path="widgets/table/table_styling/lv_example_table_styling" />
...
<LvglXMLExample name="lv_example_table_scroll" path="widgets/table/table_scroll/lv_example_table_scroll" />
...
Pure XML can't yet draw custom rendering into individual cells, so this
example stays in C. It builds a 200-row table inside a scrollable parent,
attaches an <ApiLink name="LV_EVENT_DRAW_TASK_ADDED" /> callback that paints a switch-style
toggle in the second column based on the row's `CUSTOM_1` cell control flag,
and toggles that flag from <ApiLink name="LV_EVENT_VALUE_CHANGED" />. A footer label reports
the row count and the memory cost of building the table.
