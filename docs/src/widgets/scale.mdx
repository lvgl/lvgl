...
- For the main line *when it is an arc* (<ApiLink name="LV_PART_MAIN" />):
...
- For a section *when it is an arc*:
  ...
  Positive PAD_RADIAL values move the section arc toward the center.
