...
<LvglXMLExample name="lv_example_textarea_placeholder" path="widgets/textarea/textarea_placeholder/lv_example_textarea_placeholder" />
...
<LvglXMLExample name="lv_example_textarea_cursor" path="widgets/textarea/textarea_cursor/lv_example_textarea_cursor" />
