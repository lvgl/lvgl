...
<LvglXMLExample name="lv_example_chart_types" path="widgets/chart/chart_types/lv_example_chart_types" />
...
<LvglXMLExample name="lv_example_chart_series" path="widgets/chart/chart_series/lv_example_chart_series" />
...
A practical illustration of `LV_CHART_UPDATE_MODE_CIRCULAR`: a line series is
fed by a timer that pushes a new random value each tick; the rendering loops
around the buffer, leaving a small gap that marks where the next sample
will land. Useful for ECG-style "live" plots.
...
<LvglXMLExample name="lv_example_chart_ticks_labels" path="widgets/chart/chart_ticks_labels/lv_example_chart_ticks_labels" />
...
<LvglXMLExample name="lv_example_chart_scrollable" path="widgets/chart/chart_scrollable/lv_example_chart_scrollable" />

### Cursor

<LvglXMLExample name="lv_example_chart_cursor" path="widgets/chart/chart_cursor/lv_example_chart_cursor" />
