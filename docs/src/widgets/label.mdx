...
<LvglXMLExample name="lv_example_label_styling" path="widgets/label/label_styling/lv_example_label_styling" />
...
<LvglXMLExample name="lv_example_label_bind_text" path="widgets/label/label_bind_text/lv_example_label_bind_text" />
