...
<LvglExample name="lv_example_label_long_mode" path="widgets/label/label_long_mode/lv_example_label_long_mode" />
...
<LvglExample name="lv_example_label_styling" path="widgets/label/label_styling/lv_example_label_styling" />
...
<LvglExample name="lv_example_label_bind_text" path="widgets/label/label_bind_text/lv_example_label_bind_text" />
