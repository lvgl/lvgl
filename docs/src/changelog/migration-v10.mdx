...
- **Wayland** — the backend is no longer inferred, and no longer has to be a single one.
  ...
  See the [Wayland driver docs](/main-modules/display_drivers/wayland#dma-buf).
  ...
  See the [Wayland driver docs](/main-modules/display_drivers/wayland#runtime-backend-selection) for more information.
