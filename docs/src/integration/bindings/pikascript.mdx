---
title: PikaScript
description: "PikaScript is a Python interpreter designed specifically for microcontrollers, and it supports a subset of the common Python3 syntax."
---

## What is PikaScript?

[PikaScript](https://github.com/pikasTech/PikaPython) is a Python interpreter designed specifically for
