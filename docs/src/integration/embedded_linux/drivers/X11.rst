...
The **X11** display/input `drivers <https://github.com/lvgl/lvgl/tree/master/src/drivers/x11>`__
offer support for simulating the LVGL display and keyboard/mouse inputs in an X11
desktop window.
