...
int main(int argc, char ** argv)
{
    ...
    if (lv_lcd_generic_mipi_init(my_disp, LV_LCD_FLAG_NONE, my_lcd_send_cmd, my_lcd_send_color) != LV_RESULT_OK) {
...
lv_lcd_generic_mipi_init(disp, LV_LCD_FLAG_NONE, my_lcd_send_cmd, my_lcd_send_color);
```
...
The second argument of the <ApiLink name="lv_lcd_generic_mipi_init" /> function is a flag
