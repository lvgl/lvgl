...
For the EVE HAL-based implementation with BT820 render targets and support for
earlier EVE generations, see [EVE5 renderer and display driver](/integration/external_display_controllers/eve/eve5).
...
<ApiLink name="lv_draw_eve_display_create" display="lv_draw_eve_display_create(params, op_cb, your_user_data)" /> which returns the
