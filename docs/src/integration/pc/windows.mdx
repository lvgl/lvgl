...
Windows driver's has two modes which are described in detail in [Modes](/main-modules/display_drivers/windows#modes):

- **Simulator mode**: which keeps the LVGL resolution fixed to mimic a production panel
- **Application mode**: which follows the window size, 
