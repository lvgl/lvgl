---
title: Browser
description: "There are multiple ways to view LVGL UIs in a browser or even develop UIs directly in a browser environment:"
---
...
The [lv_web_emscripten](https://github.com/lvgl/lv_web_emscripten) project provides a ready-to-use setup for compiling any LVGL UI into a browser-capable HTML file.
