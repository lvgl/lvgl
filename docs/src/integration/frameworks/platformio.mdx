...
See the [supported drivers section](/integration/external_display_controllers) for a full list.
...
Alternatively, you can use the [TFT_eSPI](https://github.com/Bodmer/TFT_eSPI) library.
