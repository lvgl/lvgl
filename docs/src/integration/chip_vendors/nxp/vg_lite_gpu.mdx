...
description: "This is a generic VG-Lite rendering backend implementation that is designed to utilize VeriSilicon's generic API to operate GPU hardware as much as possible."
---
...
3. Set the <ApiLink name="LV_VG_LITE_USE_ASSERT" /> configuration to enable GPU call parameter checking.
