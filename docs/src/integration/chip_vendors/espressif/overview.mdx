---
title: Overview
description: "Espressif Systems is a fabless chip manufacturer that produces the ESP32 series of system on chips, these chips can be based on Xtensa or Risc-V architectures, and they feature the common set of an..."
---
...
- [Support 2D Direct Memory Access (DMA2D)](/integration/chip_vendors/espressif/hardware_accelerator_dma2d)
- [Support for Pixel Processing Accelerator](/integration/chip_vendors/espressif/hardware_accelerator_ppa)
