...
description: "Renesas is an official partner of LVGL. Therefore, LVGL contains built-in support for Dave2D (the GPU of Renesas) and we also maintain ready-to-use Renesas projects."
---
...
Renesas MPUs (e.g. the RZ/G family) can use these LVGL MPU drivers.

### Wayland

Use of the Wayland driver is supported on boards with a Wayland desktop, a.k.a. a Wayland compositor.
