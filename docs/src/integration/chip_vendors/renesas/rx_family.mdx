...
- RX72 requires an external compiler for the RXv3 core. A free and open-source version is available
  ...
  ![Toolchains](/_static/images/renesas/toolchains.png)
...
- Double-click on `RX72N_EnVision_LVGL.scfg` to activate the `Configuration Window`.
  ...
  ![Code generation with SMC](/_static/images/renesas/generate_smc.png)
...
- Click the Debug button (![img_debug_btn](/_static/images/renesas/debug_btn.png)). If prompted with `Debug Configurations`, on the `Debugger` tab select the `E2 Lite`
  ...
  ![Debugger parameters for RX72](/_static/images/renesas/debug_rx72.png)
