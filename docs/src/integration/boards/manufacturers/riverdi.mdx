---
title: Riverdi
description: "Riverdi specializes in making high quality displays and the boards that carry them. They offer solutions that range from simple display panels to intelligent displays, and everything in between."
---

[Riverdi](https://riverdi.com/) specializes in making high quality
...
for [NeoChrom](/integration/chip_vendors/stm32/neochrom). NemaVG --- an extension to NeoChrom's
base support --- is implemented by this MCU.

The MCU has an LCD driver peripheral which LVGL uses to update the
display. See the [LTDC](/integration/chip_vendors/stm32/ltdc) driver docs
for more info and how to customize its use.

## Single-Board Computer Displays

The Single-Board Computer Displays are ready to use with
[Toradex](/integration/boards/manufacturers/toradex) Dahlia and Mallow carrier boards. In fact,
