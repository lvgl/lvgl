---
title: ICOP
description: ICOP makes industrial computer hardware and the development tools for them. ICOP offers an uncommon combination of hardware and software which distinguishes them from other board vendors.
---
...
See the
[LVGL port repo](https://github.com/lvgl/lv_port_icop_qec_ppc_m_090t)
