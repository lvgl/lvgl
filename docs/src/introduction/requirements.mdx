...
- **GPU**: LVGL has its own software rendering engine, but GPUs in MCUs can be enabled in `lv_conf.h`. OpenGL ES is needed only to render [gltf](https://lvgl.io/docs/open/libs/gltf)
