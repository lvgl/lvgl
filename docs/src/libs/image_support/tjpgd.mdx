...
description: "Tiny JPEG Decompressor is an LVGL interface to the TJpgDec library, a generic JPEG image decompressor module that highly optimized for small embedded systems. It works with very low memory consumption"
---
