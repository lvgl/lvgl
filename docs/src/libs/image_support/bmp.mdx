...
- The BMP file's color format needs to match the color format of the display on which
   it will be rendered (<ApiLink name="LV_COLOR_FORMAT_DEFAULT" />, or whatever the
   display was later set to).  You can use GIMP to save the image in the required
   format.  Both RGB888 and ARGB888 work with <ApiLink name="LV_COLOR_FORMAT_XRGB8888" />
