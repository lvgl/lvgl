...
Follow the OpenGL ES driver setup documentation ([OpenGL](/main-modules/display_drivers/opengl_texture)) to configure a driver that supports OpenGL for your platform.
