...
def run():
    ...
    class ProjectInfoFactory:
        ...
        # this class is to monkey patch breathe to get rid of a warning.
    ...
    breathe.project.ProjectInfoFactory = ProjectInfoFactory
    sys.modules['breathe.project'].ProjectInfoFactory = ProjectInfoFactory
