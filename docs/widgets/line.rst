...
-  ``LV_PART_MAIN`` uses all the typical background properties and line
   style properties.
...
The points have to be stored in an ``lv_point_t`` array and passed to
...
.. raw:: html
    ...
    <div include-html="widgets\line\lv_line.html"></div>
