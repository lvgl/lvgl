...
:cpp:enumerator:`lv_arc_set_bg_angles(arc, start_angle, end_angle)` functions or
...
:cpp:func:`lv_arc_set_rotation(arc, deg)`.
...
:cpp:func:`lv_arc_set_angles(arc, start_angle, end_angle)` function or
