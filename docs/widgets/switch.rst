...
:cpp:expr:`lv_obj_has_state(switch, LV_STATE_CHECKED)`.

Call :cpp:expr:`lv_obj_add_state(switch, LV_STATE_CHECKED)` to turn it on, or
:cpp:expr:`lv_obj_clear_state(switch, LV_STATE_CHECKED)` to turn it off.
