...
- Close button: :ref:`widgets/button/button (lv_button)`
- Title and text: :ref:`widgets/label/label (lv_label)`
- Buttons: :ref:`widgets/buttonmatrix/button matrix (lv_buttonmatrix)`
