...
2. Use :cpp:expr:`lv_chart_set_value_by_id(chart, ser, id, value)` where ``id`` is the
index of the point you wish to update.
...
:cpp:expr:`lv_point_t point = {10, 20}`. If the chart is scrolled the cursor
