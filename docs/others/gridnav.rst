...
manually positioned children, as well as :ref:`layouts/flex/flex` and
:ref:`layouts/grid/grid` layouts.
...
:ref:`List widget <widgets/list/list (lv_list)>`.

Gridnav assumes that the object to which gridnav is added is part of a
:ref:`group <overview/indev/groups>`. This way, if the object with
