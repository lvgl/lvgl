...
Any object can be scrollable including :ref:`widgets/obj/base object (lv_obj)`, :ref:`widgets/image/image (lv_image)`,
:ref:`widgets/button/button (lv_button)`, :ref:`widgets/scale/scale (lv_scale)`, etc
