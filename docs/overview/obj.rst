...
:ref:`Button <widgets/button/button (lv_button)>`, :ref:`Label <widgets/label/label (lv_label)>`,
:ref:`Image <widgets/image/image (lv_image)>`, :ref:`List <widgets/list/list (lv_list)>`,
:ref:`Chart <widgets/chart/chart (lv_chart)>` or :ref:`Text area <widgets/textarea/text area (lv_textarea)>`.

You can see all the :ref:`Object types <widgets/index/widgets>` here.
...
To see all the available functions visit the :ref:`Base object's documentation <widgets/obj/base object (lv_obj)>`.
...
:ref:`Documentation <widgets/index/widgets>` but you can also check the respective
...
:ref:`Base object <widgets/obj/base object (lv_obj)>` or an image to make a wallpaper.
...
Read the :ref:`Layer overview <overview/layer/layers>` section to learn more
about layers.
...
Visit :ref:`overview/display/multiple display support` to learn more.

Parts
*****

The widgets are built from multiple parts. For example a
:ref:`Base object <widgets/obj/base object (lv_obj)>` uses the main and scrollbar parts but a
:ref:`Slider <widgets/slider/slider (lv_slider)>` uses the main, indicator and knob parts.
...
:ref:`Style overview <overview/style/styles>` section.
...
:ref:`Style overview <overview/style/styles>`.

Snapshot
********

A snapshot image can be generated for an object together with its
children. Check details in :ref:`others/snapshot/snapshot`.
