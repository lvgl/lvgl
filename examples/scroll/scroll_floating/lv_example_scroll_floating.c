...
void lv_example_scroll_floating(void)
{
    ...
    lv_label_set_text(lv_label_0, "Track 1");
    ...
    lv_label_set_text(lv_label_1, "Track 2");
    ...
    lv_label_set_text(lv_label_2, "Track 3");
    ...
    lv_label_set_text(lv_label_3, "Track 4");
    ...
    lv_label_set_text(lv_label_4, "Track 5");
    ...
    lv_label_set_text(lv_label_5, "Track 6");
