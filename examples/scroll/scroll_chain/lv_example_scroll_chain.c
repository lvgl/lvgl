...
void lv_example_scroll_chain(void)
{
    ...
    lv_label_set_text(lv_label_0, "Outer 1");
    ...
    lv_label_set_text(lv_label_1, "Inner 1");
    ...
    lv_label_set_text(lv_label_2, "Inner 2");
    ...
    lv_label_set_text(lv_label_3, "Inner 3");
    ...
    lv_label_set_text(lv_label_4, "Inner 4");
    ...
    lv_label_set_text(lv_label_5, "Outer 2");
    ...
    lv_label_set_text(lv_label_6, "Outer 3");
    ...
    lv_label_set_text(lv_label_7, "Outer 4");
}
#endif
