...
void lv_example_scroll_scrollbar_style(void)
{
    ...
    lv_label_set_text(lv_label_0, "Row 1");
    ...
    lv_label_set_text(lv_label_1, "Row 2");
    ...
    lv_label_set_text(lv_label_2, "Row 3");
    ...
    lv_label_set_text(lv_label_3, "Row 4");
    ...
    lv_label_set_text(lv_label_4, "Row 5");
    ...
    lv_label_set_text(lv_label_5, "Row 6");
}
#endif
