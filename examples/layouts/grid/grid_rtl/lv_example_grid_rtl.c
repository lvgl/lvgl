...
void lv_example_grid_rtl(void)
{
    ...
    lv_label_set_text(lv_label_1, "0");
    ...
    lv_label_set_text(lv_label_2, "1");
    ...
    lv_label_set_text(lv_label_3, "2");
    ...
    lv_obj_set_style_grid_cell_column_pos(lv_label_5, 0, 0);
    lv_obj_set_style_grid_cell_row_pos(lv_label_5, 0, 0);
    lv_obj_set_style_bg_color(lv_label_5, lv_color_hex(0x3498db), 0);
    lv_label_set_text(lv_label_5, "0");
    lv_obj_add_style(lv_label_5, &style_badge, 0);

    lv_obj_t * lv_label_6 = lv_label_create(lv_obj_2);
    lv_obj_set_style_grid_cell_column_pos(lv_label_6, 1, 0);
