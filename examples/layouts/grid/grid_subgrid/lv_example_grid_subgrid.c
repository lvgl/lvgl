...
void lv_example_grid_subgrid(void)
{
    ...
    lv_label_set_text(lv_label_0, "P0,0");
    lv_obj_add_style(lv_label_0, &style_tile, 0);
    ...
    lv_obj_set_style_bg_color(lv_label_1, lv_color_hex(0x2ca02c), 0);
    lv_label_set_text(lv_label_1, "S0,0");
    ...
    lv_label_set_text(lv_label_2, "S1,0");
    ...
    lv_label_set_text(lv_label_3, "S0,1");
    ...
    lv_label_set_text(lv_label_4, "S1,1");
