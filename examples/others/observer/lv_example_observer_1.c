 ...
 *
 * `temperature_subject` is created with `lv_subject_create` and set to 28. A
...
{
    lv_subject_t * temperature_subject = lv_subject_create(LV_SUBJECT_TYPE_INT);
    lv_subject_set_int(temperature_subject, 28);
