...
#if LV_USE_IME_PINYIN && LV_BUILD_EXAMPLES
...
void lv_example_ime_pinyin_1(void)
{
    ...
    //lv_ime_pinyin_set_dict(pinyin_ime, your_dict); // Use a custom thesaurus. If it is not set, the built-in thesaurus will be used
