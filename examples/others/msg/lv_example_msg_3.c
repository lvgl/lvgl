...
void lv_example_msg_3(void)
{
    ...
    lv_obj_add_event(btn, btn_event_cb, LV_OBJ_EVENT_ALL, NULL);
    ...
    lv_obj_add_event(label, label_event_cb, LV_OBJ_EVENT_MSG_RECEIVED, NULL);
    ...
    lv_obj_add_event(slider, slider_event_cb, LV_OBJ_EVENT_ALL, NULL);
...
static void label_event_cb(lv_event_t * e)
{
    ...
    lv_event_code_t code = lv_event_get_code(e);
    if(code == LV_OBJ_EVENT_MSG_RECEIVED) {
