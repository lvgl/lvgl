...
void lv_example_msg_2(void)
{
    ...
    lv_obj_add_event_cb(ta, textarea_event_cb, LV_OBJ_EVENT_ALL, NULL);
    ...
    lv_obj_add_event_cb(btn, log_out_event_cb, LV_OBJ_EVENT_ALL, NULL);
    ...
    lv_obj_add_event_cb(label, info_label_msg_event_cb, LV_OBJ_EVENT_MSG_RECEIVED, NULL);
    ...
    lv_obj_add_event_cb(btn, start_engine_msg_event_cb, LV_OBJ_EVENT_MSG_RECEIVED, NULL);
