...
void lv_example_anim_timeline_1(void)
{
    ...
    lv_obj_add_event_cb(btn_start, btn_start_event_handler, LV_OBJ_EVENT_VALUE_CHANGED, NULL);
    ...
    lv_obj_add_event_cb(btn_del, btn_del_event_handler, LV_OBJ_EVENT_CLICKED, NULL);
    ...
    lv_obj_add_event_cb(btn_stop, btn_stop_event_handler, LV_OBJ_EVENT_CLICKED, NULL);
    ...
    lv_obj_add_event_cb(slider_prg, slider_prg_event_handler, LV_OBJ_EVENT_VALUE_CHANGED, NULL);
