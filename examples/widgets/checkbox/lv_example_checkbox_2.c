...
void lv_example_checkbox_2(void)
{
    ...
    lv_obj_add_event(cont1, radio_event_handler, LV_OBJ_EVENT_CLICKED, &active_index_1);
    ...
    lv_obj_add_event(cont2, radio_event_handler, LV_OBJ_EVENT_CLICKED, &active_index_2);
