...
void lv_example_menu_5(void)
{
    ...
    lv_obj_add_event(menu, back_event_handler, LV_OBJ_EVENT_CLICKED, menu);
    ...
    lv_obj_add_event(lv_obj_get_child(cont, 2), switch_handler, LV_OBJ_EVENT_VALUE_CHANGED, menu);
