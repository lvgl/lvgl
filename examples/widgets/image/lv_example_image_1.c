...
void lv_example_image_1(void)
{
    ...
    //    lv_obj_t * obj = lv_calendar_create(lv_screen_active());
    //    lv_obj_center(obj);
    //    lv_obj_set_style_backdrop_blur_intensity(obj, 200, 0);
    //    lv_obj_set_style_bg_opa(obj, 100, 0);
    //    lv_obj_set_style_border_opa(obj, 100, 0);


    lv_obj_t * obj = lv_slider_create(lv_screen_active());
    lv_obj_set_style_backdrop_blur_intensity(obj, 170, LV_PART_INDICATOR);
    lv_obj_set_style_bg_opa(obj, 80, LV_PART_INDICATOR);
