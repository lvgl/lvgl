...
void lv_example_span_1(void)
{
    ...
    lv_spangroup_set_span_style(spans, span, &span0_style);
    ...
    lv_spangroup_set_span_style(spans, span, &span1_style);
...
#  endif
    ...
    lv_spangroup_set_span_style(spans, span, &span4_style);
