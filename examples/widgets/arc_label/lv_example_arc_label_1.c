...
static void timer_cb(lv_timer_t * timer)
{
    ...
    lv_arc_label_set_angle_start(arc_label_inner, anim_index / 4);
    lv_arc_label_set_radius(arc_label_inner, LV_PCT(80 - (20 + 20 *  lv_trigo_sin(anim_index) / 32768)));
    lv_arc_label_set_center_offset_y(arc_label_inner, 20 + (20 *  lv_trigo_sin(anim_index) / 32768));

    lv_arc_label_set_angle_start(arc_label_outer, anim_index / 8);

    lv_arc_label_set_offset(arc_label_slogan_1, 20 * lv_trigo_sin(anim_index) / 32768);
    lv_arc_label_set_radius(arc_label_slogan_1, 150 - (10 + 10 * lv_trigo_sin(anim_index / 2) / 32768));
    lv_arc_label_set_offset(arc_label_slogan_2, 20 * lv_trigo_sin(anim_index) / 32768);
    lv_arc_label_set_radius(arc_label_slogan_2, 150 - (10 + 10 * lv_trigo_sin(anim_index / 2) / 32768));
...
void lv_example_arc_label_1(void)
{
    ...
    lv_obj_set_style_text_letter_space(arc_label_outer, 3, LV_PART_MAIN);
    ...
    lv_obj_set_style_text_letter_space(arc_label_slogan_1, 3, LV_PART_MAIN);
    ...
    lv_obj_set_style_text_letter_space(arc_label_slogan_2, 3, LV_PART_MAIN);
    ...
    lv_timer_create(timer_cb, 8, NULL);
}
