...
void lv_example_label_text_align(void)
{
    ...
    lv_obj_set_width(lv_label_0, 220);
    lv_obj_set_style_text_align(lv_label_0, LV_TEXT_ALIGN_LEFT, 0);
    lv_label_set_text(lv_label_0, "Left aligned\nSecond line");
    ...
    lv_label_set_text(lv_label_1, "Centered\nSecond line");

    /* Right-aligned multi-line label */
    lv_obj_t * lv_label_2 = lv_label_create(screen);
    lv_obj_set_width(lv_label_2, 220);
    lv_obj_set_style_text_align(lv_label_2, LV_TEXT_ALIGN_RIGHT, 0);
    lv_label_set_text(lv_label_2, "Right aligned\nSecond line");
}
#endif
