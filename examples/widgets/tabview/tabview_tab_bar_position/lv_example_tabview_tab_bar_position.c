...
void lv_example_tabview_tab_bar_position(void)
{
    ...
    lv_label_set_text(lv_label_0, "top");
    ...
    lv_label_set_text(lv_label_1, "bottom");
    ...
    lv_obj_t * lv_label_2 = lv_label_create(lv_tabview_tab_4);
    lv_obj_set_align(lv_label_2, LV_ALIGN_CENTER);
    lv_label_set_text(lv_label_2, "left");
    ...
    lv_obj_t * lv_label_3 = lv_label_create(lv_tabview_tab_6);
    lv_obj_set_align(lv_label_3, LV_ALIGN_CENTER);
    lv_label_set_text(lv_label_3, "right");
