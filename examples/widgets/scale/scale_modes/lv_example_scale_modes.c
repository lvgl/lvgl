...
void lv_example_scale_modes(void)
{
    ...
    lv_obj_set_size(lv_scale_0, 160, 60);
    ...
    lv_obj_set_size(lv_scale_1, 160, 60);
    ...
    lv_obj_set_size(lv_scale_2, 60, 160);
    ...
    lv_obj_t * lv_scale_3 = lv_scale_create(screen);
    lv_obj_set_size(lv_scale_3, 60, 160);
