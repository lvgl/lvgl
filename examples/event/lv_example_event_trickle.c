...
void lv_example_event_trickle(void)
{
    ...
    lv_style_set_text_color(&style_green, lv_color_white());
    ...
    lv_obj_add_style(cont, &style_green, LV_STATE_PRESSED);
    ...
    for(i = 0; i < 9; i++) {
        ...
        lv_obj_add_style(subcont, &style_green, LV_STATE_FOCUSED);
    }
}
