...
/**
 * Set the direction in which the display rotation is applied to the indev's points.
 *
 * @param indev         pointer to an indev
 * @param rotation_dir  rotation direction see @ref lv_rotation_dir_t
 */
void lv_indev_set_rotation_dir(lv_indev_t * indev, lv_rotation_dir_t rotation_dir);

/**
 * Get the direction in which the display rotation is applied to the indev's points.
 * @param indev    pointer to an indev
 * @return         a @ref lv_rotation_dir_t value
 */
