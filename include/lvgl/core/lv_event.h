...
typedef enum {
    ...
    LV_EVENT_PARTIAL_SYNC_START,         /**< Sent before partial sync callback is called. */
    LV_EVENT_PARTIAL_SYNC_FINISH,        /**< Sent after partial sync callback call has returned. */
    LV_EVENT_PARTIAL_SYNC_WAIT_START,    /**< Sent before partial sync wait callback is called. */
    LV_EVENT_PARTIAL_SYNC_WAIT_FINISH,   /**< Sent after partial sync wait callback call has returned. */
