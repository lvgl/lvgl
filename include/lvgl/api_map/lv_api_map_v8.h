...
#define LV_DISP_ROT_NONE    LV_ROTATION_0
#define LV_DISP_ROT_90      LV_ROTATION_90
#define LV_DISP_ROT_180     LV_ROTATION_180
#define LV_DISP_ROT_270     LV_ROTATION_270
...
typedef lv_rotation_t       lv_disp_rot_t;
