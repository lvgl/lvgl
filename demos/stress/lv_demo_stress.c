...
static void obj_test_task_cb(lv_timer_t * tmr)
{
    ...
    switch(state) {
        ...
        case 8:
            ...
            lv_win_add_btn(obj, lv_img_src_from_symbol(LV_SYMBOL_CLOSE, 0), 40);
            lv_win_add_btn(obj, lv_img_src_from_symbol(LV_SYMBOL_DOWN, 0), 40);
        ...
        case 18:
            ...
            {
                lv_obj_t * b;
                b = lv_list_add_btn(obj, lv_img_src_from_symbol(LV_SYMBOL_OK, 0), "1. Some very long text to scroll");
                auto_del(b, 10);
                lv_list_add_btn(obj, lv_img_src_from_symbol(LV_SYMBOL_OK, 0), "2. Some very long text to scroll");
                lv_list_add_btn(obj, lv_img_src_from_symbol(LV_SYMBOL_OK, 0), "3. Some very long text to scroll");
                b = lv_list_add_btn(obj, lv_img_src_from_symbol(LV_SYMBOL_OK, 0), "4. Some very long text to scroll");
                auto_del(b, LV_DEMO_STRESS_TIME_STEP);
                b = lv_list_add_btn(obj, lv_img_src_from_symbol(LV_SYMBOL_OK, 0), "5. Some very long text to scroll");
                auto_del(b, LV_DEMO_STRESS_TIME_STEP + 90);
                b = lv_list_add_btn(obj, lv_img_src_from_symbol(LV_SYMBOL_OK, 0), "6. Some very long text to scroll");
