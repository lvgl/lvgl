...
static scene_dsc_t scenes[] = {
    ...
    {.name = "Image RGB rotate",             .weight = 10, .create_cb = img_rgb_rot_cb},
    {.name = "Image RGB rotate anti aliased", .weight = 15, .create_cb = img_rgb_rot_aa_cb},
    {.name = "Image ARGB rotate",            .weight = 25, .create_cb = img_argb_rot_cb},
    {.name = "Image ARGB rotate anti aliased", .weight = 30, .create_cb = img_argb_rot_aa_cb},
    {.name = "Image RGB zoom",               .weight = 10, .create_cb = img_rgb_zoom_cb},
    {.name = "Image RGB zoom anti aliased",  .weight = 15, .create_cb = img_rgb_zoom_aa_cb},
    {.name = "Image ARGB zoom",              .weight = 20, .create_cb = img_argb_zoom_cb},
    {.name = "Image ARGB zoom anti aliased", .weight = 25, .create_cb = img_argb_zoom_aa_cb},
