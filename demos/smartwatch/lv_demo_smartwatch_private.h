...
LV_IMG_DECLARE(img_wechat_pay_icon);        /* assets/wechat_pay.png */
LV_IMG_DECLARE(img_alipay_icon);            /* assets/alipay.png */
LV_IMG_DECLARE(img_paypal_icon);            /* assets/paypal.png */
LV_IMG_DECLARE(img_digital_preview);        /* assets/digital_preview.png */
LV_IMG_DECLARE(img_alert_icon);             /* assets/alert.png */
LV_IMG_DECLARE(img_general_settings_icon);  /* assets/general_settings.png */
LV_IMG_DECLARE(img_notifications_app_icon); /* assets/notifications_app.png */
LV_IMG_DECLARE(img_weather_app_icon);       /* assets/weather_app.png */
