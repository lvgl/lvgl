...
lv_obj_t *lv_smartwatch_settings_add_slider(uint16_t id, const char *name, const lv_img_dsc_t *img, int32_t value, int32_t min, int32_t max)
{
      ...
      lv_obj_add_event_cb(slider, settings_action_event_cb, LV_EVENT_VALUE_CHANGED, (void *)(intptr_t)((ST_SLIDER << 16) | id));
...
lv_obj_t *lv_smartwatch_settings_add_toggle(uint16_t id, const char *name, const lv_img_dsc_t *img, bool state)
{
      ...
      lv_obj_add_event_cb(toggle, settings_action_event_cb, LV_EVENT_VALUE_CHANGED, (void *)(intptr_t)((ST_SWITCH << 16) | id));
...
lv_obj_t *lv_smartwatch_settings_add_dropdown(uint16_t id, const char *name, const lv_img_dsc_t *img, const char *options)
{
      ...
      lv_obj_add_event_cb(dropdown, settings_action_event_cb, LV_EVENT_VALUE_CHANGED, (void *)(intptr_t)((ST_DROPDOWN << 16) | id));
...
static void settings_action_event_cb(lv_event_t *e)
{
      ...
      {
      case 0x0002:
            lv_smartwatch_set_circular_scroll(lv_obj_has_state(target, LV_STATE_CHECKED));
            break;
      case 0x0007:
...
static void create_screen_settings()
{
      ...
      lv_smartwatch_settings_add_slider(0x0001, "Screen Brightness", &img_brightness_icon, 50, 1, 255);
      lv_smartwatch_settings_add_toggle(0x0002, "Circular Scroll", &img_scrolling_icon, true);
      lv_smartwatch_settings_add_dropdown(0x0003, "Screen Timeout", &img_timeout_icon, "5 Seconds\n10 Seconds\n20 Seconds\n30 Seconds\nAlways On");
      lv_smartwatch_settings_add_dropdown(0x0004, "Screen Rotation", &img_screen_rotate_icon, "Default\n90\n180\n270");
      lv_smartwatch_settings_add_toggle(0x0005, "Show Alerts", &img_alert_icon, false);
      about_label = lv_smartwatch_settings_add_label(0x0006, "LVGL Demo\nSmart Watch UI\n11:22:33:44:55:66", &img_info_icon);
      lv_smartwatch_settings_add_label(0x0007, "Made with love\nin Kenya\nusing LVGL", &img_kenya_icon);

      lv_obj_add_event_cb(settings_list, lv_smartwatch_scroll_event, LV_EVENT_ALL, NULL);
