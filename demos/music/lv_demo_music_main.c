...
static lv_obj_t * create_spectrum_obj(lv_obj_t * parent)
{
    ...
    lv_obj_add_event(obj, spectrum_draw_event_cb, LV_OBJ_EVENT_ALL, NULL);
...
static lv_obj_t * create_ctrl_box(lv_obj_t * parent)
{
    ...
    lv_obj_add_event(icon, prev_click_event_cb, LV_OBJ_EVENT_CLICKED, NULL);
    ...
    lv_obj_add_event(play_obj, play_event_click_cb, LV_OBJ_EVENT_CLICKED, NULL);
    ...
    lv_obj_add_event(icon, next_click_event_cb, LV_OBJ_EVENT_CLICKED, NULL);
...
static lv_obj_t * album_img_create(lv_obj_t * parent)
{
    ...
    lv_obj_add_event(img, album_gesture_event_cb, LV_OBJ_EVENT_GESTURE, NULL);
