...
#ifndef LV_ATTRIBUTE_IMG_IMG_EMOJI_BOOKS
    #define LV_ATTRIBUTE_IMG_IMG_EMOJI_BOOKS
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_IMG_EMOJI_BOOKS uint8_t img_emoji_books_map[] = {
...
const lv_img_dsc_t img_emoji_books = {
