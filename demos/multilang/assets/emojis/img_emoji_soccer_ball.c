...
#ifndef LV_ATTRIBUTE_IMG_IMG_EMOJI_SOCCER_BALL
    #define LV_ATTRIBUTE_IMG_IMG_EMOJI_SOCCER_BALL
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_IMG_EMOJI_SOCCER_BALL uint8_t
...
const lv_img_dsc_t img_emoji_soccer_ball = {
