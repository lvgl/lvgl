...
#ifndef LV_ATTRIBUTE_IMG_IMG_EMOJI_CAT_FACE
    #define LV_ATTRIBUTE_IMG_IMG_EMOJI_CAT_FACE
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_IMG_EMOJI_CAT_FACE uint8_t
...
const lv_img_dsc_t img_emoji_cat_face = {
