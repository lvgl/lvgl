...
#ifndef LV_ATTRIBUTE_IMG_IMG_EMOJI_RED_HEART
    #define LV_ATTRIBUTE_IMG_IMG_EMOJI_RED_HEART
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_IMG_EMOJI_RED_HEART uint8_t
...
const lv_img_dsc_t img_emoji_red_heart = {
