...
#ifndef LV_ATTRIBUTE_IMG_IMG_EMOJI_FLEXED_BICEPS
    #define LV_ATTRIBUTE_IMG_IMG_EMOJI_FLEXED_BICEPS
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_IMG_EMOJI_FLEXED_BICEPS uint8_t
