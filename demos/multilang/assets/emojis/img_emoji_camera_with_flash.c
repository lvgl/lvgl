...
#ifndef LV_ATTRIBUTE_IMG_IMG_EMOJI_CAMERA_WITH_FLASH
    #define LV_ATTRIBUTE_IMG_IMG_EMOJI_CAMERA_WITH_FLASH
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_IMG_EMOJI_CAMERA_WITH_FLASH uint8_t
...
const lv_img_dsc_t img_emoji_camera_with_flash = {
