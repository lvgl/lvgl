...
LV_ATTRIBUTE_EXTERN extern const lv_obj_class_t lv_list_class;
LV_ATTRIBUTE_EXTERN extern const lv_obj_class_t lv_list_text_class;
LV_ATTRIBUTE_EXTERN extern const lv_obj_class_t lv_list_button_class;
/**********************
 * GLOBAL PROTOTYPES
 **********************/
