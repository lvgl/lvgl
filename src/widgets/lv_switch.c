...
static void lv_switch_anim(void * sw, int32_t value);
...
void lv_switch_set_anim(lv_obj_t * obj)
{
    ...
    if(anim_dur_full>0) {
        ...
        lv_anim_set_exec_cb(&a, lv_switch_anim);
...
static void lv_switch_anim(void * var, int32_t value)
{
