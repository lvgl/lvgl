...
static void lv_keyboard_update_ctrl_map(lv_obj_t * obj);
    ...
    static void lv_keyboard_hidden_candidate_cont(lv_obj_t * obj);
    static void lv_keyboard_update_candidate_btnm_map(lv_obj_t * obj);
    static void lv_keyboard_update_candidate_cont_layout(lv_obj_t * obj);
    static char * lv_keyboard_search_chinese(size_t * candidate_num, lv_obj_t * obj, const char * pinyin_str);
    static void lv_keyboard_free_candidate_btnm_map(lv_obj_t * obj);

    #if LV_KEYBOARD_PINYIN_USE_EXT_BUTTONMATRIX
        static void lv_keyboard_ext_btn_event_cb(lv_event_t * e);
        static void lv_keyboard_ext_candidate_btnm_event_cb(lv_event_t * e);
        static void lv_keyboard_hidden_ext_candidate_btnm(lv_obj_t * obj);
        static void lv_keyboard_update_ext_candidate_btnm_map(lv_obj_t * obj);
        static void lv_keyboard_free_ext_candidate_btnm_map(lv_obj_t * obj);
    #endif
#endif
...
const lv_obj_class_t lv_keyboard_class = {
    ...
    #define LV_ARABIC_PERSIAN_KEY  "أب",
    #define LV_ARABIC_PERSIAN_CTRL  (LV_KEYBOARD_CTRL_BUTTON_FLAGS | 2),
#else
    #define LV_ARABIC_PERSIAN_KEY
    #define LV_ARABIC_PERSIAN_CTRL
#endif

#if LV_KEYBOARD_PINYIN
    #define LV_PINYIN_KEY   "zh",
    #define LV_PINYIN_CTRL  (LV_KEYBOARD_CTRL_BUTTON_FLAGS | 2),
#else
    #define LV_PINYIN_KEY
    #define LV_PINYIN_CTRL
#endif
...
#if LV_KEYBOARD_PINYIN
static const char * const default_kb_map_pinyin[] = {" ", "\n", /*candidate content*/
                                                     "1#", "q", "w", "e", "r", "t", "y", "u", "i", "o", "p", LV_SYMBOL_BACKSPACE, "\n",
                                                     "ABC", "a", "s", "d", "f", "g", "h", "j", "k", "l", LV_SYMBOL_NEW_LINE, "\n",
                                                     " ", " ", "z", "x", "c", "v", "b", "n", "m", " ", " ", " ", "\n",
                                                     LV_SYMBOL_CLOSE, "abc", LV_SYMBOL_LEFT, " ", LV_SYMBOL_RIGHT, LV_SYMBOL_OK, ""
                                                    };

static const lv_buttonmatrix_ctrl_t default_kb_ctrl_pinyin_map[] = {
    LV_BUTTONMATRIX_CTRL_HIDDEN,
    LV_KEYBOARD_CTRL_BUTTON_FLAGS | 5, LV_KB_BTN(4), LV_KB_BTN(4), LV_KB_BTN(4), LV_KB_BTN(4), LV_KB_BTN(4), LV_KB_BTN(4), LV_KB_BTN(4), LV_KB_BTN(4), LV_KB_BTN(4), LV_KB_BTN(4), LV_BUTTONMATRIX_CTRL_CHECKED | 7,
    LV_KEYBOARD_CTRL_BUTTON_FLAGS | 6, LV_KB_BTN(3), LV_KB_BTN(3), LV_KB_BTN(3), LV_KB_BTN(3), LV_KB_BTN(3), LV_KB_BTN(3), LV_KB_BTN(3), LV_KB_BTN(3), LV_KB_BTN(3), LV_BUTTONMATRIX_CTRL_CHECKED | 7,
    LV_BUTTONMATRIX_CTRL_HIDDEN | LV_KB_BTN(1), LV_BUTTONMATRIX_CTRL_HIDDEN | LV_KB_BTN(1), LV_KB_BTN(1), LV_KB_BTN(1), LV_KB_BTN(1), LV_KB_BTN(1), LV_KB_BTN(1), LV_KB_BTN(1), LV_KB_BTN(1), LV_BUTTONMATRIX_CTRL_HIDDEN | LV_KB_BTN(1), LV_BUTTONMATRIX_CTRL_HIDDEN | LV_KB_BTN(1), LV_BUTTONMATRIX_CTRL_HIDDEN | LV_KB_BTN(1),
    LV_KEYBOARD_CTRL_BUTTON_FLAGS | 2, LV_KEYBOARD_CTRL_BUTTON_FLAGS | 2, LV_BUTTONMATRIX_CTRL_CHECKED | 2, 6, LV_BUTTONMATRIX_CTRL_CHECKED | 2, LV_KEYBOARD_CTRL_BUTTON_FLAGS | 2
};
#endif
...
static const char * * kb_map[LV_KEYBOARD_MODE_MAX + 1] = {
...
#if LV_KEYBOARD_PINYIN
    (const char * *)default_kb_map_pinyin,
#endif
    (const char * *)NULL
};
static const lv_buttonmatrix_ctrl_t * kb_ctrl[LV_KEYBOARD_MODE_MAX + 1] = {
...
void lv_keyboard_set_textarea(lv_obj_t * obj, lv_obj_t * ta)
{
    ...
    /*Clear pinyin and hidden candidate content when the Text area defocused*/
        ...
        lv_keyboard_hidden_candidate_cont(obj);
        lv_keyboard_free_candidate_btnm_map(obj);
#if LV_KEYBOARD_PINYIN_USE_EXT_BUTTONMATRIX
        lv_keyboard_hidden_ext_candidate_btnm(obj);
        lv_keyboard_free_ext_candidate_btnm_map(obj);
#endif
    }
#endif
}
...
void lv_keyboard_def_event_cb(lv_event_t * e)
{
    ...
    if(lv_strcmp(txt, "abc") == 0) {
        ...
        lv_keyboard_set_mode(obj, LV_KEYBOARD_MODE_TEXT_ARABIC);
        return;
    }
#endif
        ...
        lv_keyboard_set_mode(obj, LV_KEYBOARD_MODE_PINYIN);
        return;
    }
#endif
    ...
    if(lv_strcmp(txt, "Enter") == 0 || lv_strcmp(txt, LV_SYMBOL_NEW_LINE) == 0) {
        ...
        if(keyboard->mode != LV_KEYBOARD_MODE_PINYIN) {
            ...
            if(input_pinyin_len > 0) {
                ...
                lv_keyboard_update_candidate_btnm_map(obj);
                lv_keyboard_update_candidate_cont_layout(obj);
            }
            else {
                lv_textarea_delete_char(keyboard->ta);
            }
...
#endif /*LV_KEYBOARD_PINYIN_USE_EXT_BUTTONMATRIX*/
...
static void lv_keyboard_update_candidate_btnm_map(lv_obj_t * obj)
{
    ...
    char * candidate_str = lv_keyboard_search_chinese(&candidate_num, obj, input_pinyin);
    ...
    LV_ASSERT_NULL(keyboard->candidate_btnm_map);
...
static void lv_keyboard_update_candidate_cont_layout(lv_obj_t * obj)
{
    ...
    char * input_pinyin = lv_label_get_text(keyboard->pinyin_label);
    if(input_pinyin == NULL || lv_strlen(input_pinyin) == 0) {
        lv_obj_add_flag(keyboard->candidate_cont, LV_OBJ_FLAG_HIDDEN);
        return;
    }

    int32_t btnm_height = lv_obj_get_height(keyboard->candidate_btnm);
    int32_t btnm_width = btnm_height * keyboard->candidate_num;
    lv_obj_set_width(keyboard->candidate_btnm, btnm_width);
    lv_obj_scroll_to_view_recursive(keyboard->candidate_btnm, LV_ANIM_OFF);
...
static void lv_keyboard_free_candidate_btnm_map(lv_obj_t * obj)
{
    ...
    if(keyboard->candidate_num != 0) {
        ...
        if(lv_obj_is_valid(keyboard->candidate_btnm)) {
            lv_buttonmatrix_set_map(keyboard->candidate_btnm, (const char **)"");
        }
    }
}
...
static void lv_keyboard_ext_btn_event_cb(lv_event_t * e)
{
    ...
    if(code == LV_EVENT_VALUE_CHANGED) {
        if(lv_obj_has_state(keyboard->ext_btn, LV_STATE_CHECKED)) {
            ...
            lv_keyboard_update_ext_candidate_btnm_map(obj);
...
static void lv_keyboard_update_ext_candidate_btnm_map(lv_obj_t * obj)
{
    ...
    int32_t keyboard_width = lv_obj_get_width(obj);
...
static void lv_keyboard_free_ext_candidate_btnm_map(lv_obj_t * obj)
{
    ...
    if(keyboard->ext_candidate_num != 0) {
        ...
        if(lv_obj_is_valid(keyboard->ext_candidate_btnm)) {
            lv_buttonmatrix_set_map(keyboard->ext_candidate_btnm, (const char **)"");
        }
    }
}
#endif
