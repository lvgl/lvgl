...
static void lv_arc_draw(lv_event_t * e)
{
    ...
    if(arc_r > 0) {
        ...
        lv_draw_arc(draw, &arc_dsc, &center, part_draw_dsc.radius, arc->bg_angle_start + arc->rotation,
    ...
    if(indic_r > 0) {
        ...
        lv_draw_arc(draw, &arc_dsc, &center, part_draw_dsc.radius, arc->indic_angle_start + arc->rotation,
