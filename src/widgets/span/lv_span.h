...
enum {
    LV_PROPERTY_ID(SPANGROUP, ALIGN,     LV_PROPERTY_TYPE_INT, 0),
    LV_PROPERTY_ID(SPANGROUP, OVERFLOW,  LV_PROPERTY_TYPE_INT, 1),
    LV_PROPERTY_ID(SPANGROUP, INDENT,    LV_PROPERTY_TYPE_INT, 2),
    LV_PROPERTY_ID(SPANGROUP, MODE,      LV_PROPERTY_TYPE_INT, 3),
    LV_PROPERTY_ID(SPANGROUP, MAX_LINES, LV_PROPERTY_TYPE_INT, 4),
    LV_PROPERTY_SPANGROUP_END,
};
#endif
