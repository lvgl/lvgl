...
LV_ATTRIBUTE_EXTERN extern const lv_obj_class_t lv_msgbox_class;
LV_ATTRIBUTE_EXTERN extern const lv_obj_class_t lv_msgbox_content_class;
LV_ATTRIBUTE_EXTERN extern const lv_obj_class_t lv_msgbox_backdrop_class;
