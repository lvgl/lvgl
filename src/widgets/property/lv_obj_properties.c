...
const lv_property_name_t lv_obj_property_names[100] = {
    ...
    {"click_focusable",        LV_PROPERTY_OBJ_CLICK_FOCUSABLE,},
    {"clickable",              LV_PROPERTY_OBJ_CLICKABLE,},
    {"content_height",         LV_PROPERTY_OBJ_CONTENT_HEIGHT,},
    {"content_width",          LV_PROPERTY_OBJ_CONTENT_WIDTH,},
    {"display",                LV_PROPERTY_OBJ_DISPLAY,},
    {"event_bubble",           LV_PROPERTY_OBJ_EVENT_BUBBLE,},
    {"event_count",            LV_PROPERTY_OBJ_EVENT_COUNT,},
    {"event_trickle",          LV_PROPERTY_OBJ_EVENT_TRICKLE,},
    ...
    {"flex_in_new_track",      LV_PROPERTY_OBJ_FLEX_IN_NEW_TRACK,},
    {"floating",               LV_PROPERTY_OBJ_FLOATING,},
    {"gesture_bubble",         LV_PROPERTY_OBJ_GESTURE_BUBBLE,},
    {"h",                      LV_PROPERTY_OBJ_H,},
    {"hidden",                 LV_PROPERTY_OBJ_HIDDEN,},
    ...
    {"scroll_chain_hor",       LV_PROPERTY_OBJ_SCROLL_CHAIN_HOR,},
    {"scroll_chain_ver",       LV_PROPERTY_OBJ_SCROLL_CHAIN_VER,},
    {"scroll_dir",             LV_PROPERTY_OBJ_SCROLL_DIR,},
    {"scroll_elastic",         LV_PROPERTY_OBJ_SCROLL_ELASTIC,},
    {"scroll_end",             LV_PROPERTY_OBJ_SCROLL_END,},
    {"scroll_left",            LV_PROPERTY_OBJ_SCROLL_LEFT,},
    {"scroll_momentum",        LV_PROPERTY_OBJ_SCROLL_MOMENTUM,},
    {"scroll_on_focus",        LV_PROPERTY_OBJ_SCROLL_ON_FOCUS,},
    {"scroll_one",             LV_PROPERTY_OBJ_SCROLL_ONE,},
    ...
    {"scroll_with_arrow",      LV_PROPERTY_OBJ_SCROLL_WITH_ARROW,},
    {"scroll_x",               LV_PROPERTY_OBJ_SCROLL_X,},
    {"scroll_y",               LV_PROPERTY_OBJ_SCROLL_Y,},
    {"scrollable",             LV_PROPERTY_OBJ_SCROLLABLE,},
    {"scrollbar_mode",         LV_PROPERTY_OBJ_SCROLLBAR_MODE,},
    {"send_draw_task_events",  LV_PROPERTY_OBJ_SEND_DRAW_TASK_EVENTS,},
    {"snappable",              LV_PROPERTY_OBJ_SNAPPABLE,},
    ...
    {"state_trickle",          LV_PROPERTY_OBJ_STATE_TRICKLE,},
