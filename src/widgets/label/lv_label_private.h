...
#ifdef CONFIG_LV_LABEL_ENABLE_AGGRESSIVE_CACHING
#   define LV_LABEL_ENABLE_AGGRESSIVE_CACHING CONFIG_LV_LABEL_ENABLE_AGGRESSIVE_CACHING
#else
#   define LV_LABEL_ENABLE_AGGRESSIVE_CACHING 0
#endif
