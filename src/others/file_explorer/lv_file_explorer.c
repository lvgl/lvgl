...
static void lv_file_explorer_constructor(const lv_obj_class_t * class_p, lv_obj_t * obj)
{
    ...
    lv_obj_add_event_cb(explorer->quick_access_area, quick_access_area_event_handler, LV_OBJ_EVENT_ALL,
                        explorer);
#endif
    ...
    lv_obj_add_event_cb(btn, quick_access_event_handler, LV_OBJ_EVENT_CLICKED, obj);
    ...
    lv_obj_add_event_cb(explorer->file_table, browser_file_event_handler, LV_OBJ_EVENT_ALL, obj);
...
static void quick_access_area_event_handler(lv_event_t * e)
{
    ...
    if(code == LV_OBJ_EVENT_LAYOUT_CHANGED) {
...
static void browser_file_event_handler(lv_event_t * e)
{
    ...
    else if((code == LV_OBJ_EVENT_CLICKED) || (code == LV_OBJ_EVENT_RELEASED)) {
        lv_obj_send_event(obj, LV_OBJ_EVENT_CLICKED, NULL);
    }
}
