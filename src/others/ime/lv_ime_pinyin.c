...
void lv_ime_pinyin_set_keyboard(lv_obj_t * obj, lv_obj_t * kb)
{
    ...
    lv_obj_add_event(pinyin_ime->kb, lv_ime_pinyin_kb_event, LV_OBJ_EVENT_VALUE_CHANGED, obj);
...
static void lv_ime_pinyin_constructor(const lv_obj_class_t * class_p, lv_obj_t * obj)
{
    ...
    /* event handler */
    lv_obj_add_event(pinyin_ime->cand_panel, lv_ime_pinyin_cand_panel_event, LV_OBJ_EVENT_VALUE_CHANGED, obj);
    lv_obj_add_event(obj, lv_ime_pinyin_style_change_event, LV_OBJ_EVENT_STYLE_CHANGED, NULL);
