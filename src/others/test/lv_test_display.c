...
static void buf_changed_event_cb(lv_event_t * e)
{
    ...
    int32_t hor_res = lv_display_get_horizontal_resolution_with_matrix_rotation(disp);
    int32_t ver_res = lv_display_get_vertical_resolution_with_matrix_rotation(disp);
