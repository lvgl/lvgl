...
static inline const void * lv_obj_get_style_anim(const struct _lv_obj_t * obj, uint32_t part)
{
...
void lv_obj_set_style_anim(struct _lv_obj_t * obj, const void * value, lv_style_selector_t selector);
