...
void lv_obj_del(lv_obj_t * obj)
{
    ...
    if(par) {
        ...
        lv_obj_scrollbar_invalidate(par);
        lv_obj_send_event(par, LV_OBJ_EVENT_CHILD_CHANGED, NULL);
        lv_obj_send_event(par, LV_OBJ_EVENT_CHILD_DELETED, NULL);
    }
...
void lv_obj_set_parent(lv_obj_t * obj, lv_obj_t * parent)
{
    ...
    lv_obj_send_event(old_parent, LV_OBJ_EVENT_CHILD_CHANGED, obj);
    lv_obj_send_event(old_parent, LV_OBJ_EVENT_CHILD_DELETED, NULL);

    /*Notify the new parent about the child*/
    lv_obj_send_event(parent, LV_OBJ_EVENT_CHILD_CHANGED, obj);
    lv_obj_send_event(parent, LV_OBJ_EVENT_CHILD_CREATED, NULL);
...
void lv_obj_move_to_index(lv_obj_t * obj, int32_t index)
{
    ...
    lv_obj_send_event(parent, LV_OBJ_EVENT_CHILD_CHANGED, NULL);
...
void lv_obj_swap(lv_obj_t * obj1, lv_obj_t * obj2)
{
    ...
    lv_obj_send_event(parent2, LV_OBJ_EVENT_CHILD_DELETED, obj2);
    lv_obj_send_event(parent, LV_OBJ_EVENT_CHILD_DELETED, obj1);

    parent->spec_attr->children[index1] = obj2;
    parent2->spec_attr->children[index2] = obj1;

    lv_obj_send_event(parent, LV_OBJ_EVENT_CHILD_CHANGED, obj2);
    lv_obj_send_event(parent, LV_OBJ_EVENT_CHILD_CREATED, obj2);
    lv_obj_send_event(parent2, LV_OBJ_EVENT_CHILD_CHANGED, obj1);
    lv_obj_send_event(parent2, LV_OBJ_EVENT_CHILD_CREATED, obj1);
...
static void obj_del_core(lv_obj_t * obj)
{
    /*Let the user free the resources used in `LV_OBJ_EVENT_DELETE`*/
    lv_res_t res = lv_obj_send_event(obj, LV_OBJ_EVENT_DELETE, NULL);
