...
/**
 * @brief Calculates the dynamic width of an LVGL object based on its style and parent.
 * @param obj Pointer to the LVGL object whose width is being calculated.
 * @param prop LV_STYLE_WIDTH, LV_STYLE_MIN_WIDTH, or LV_STYLE_MAX_WIDTH
 ...
 */
int32_t calc_dynamic_width(lv_obj_t * obj, lv_style_prop_t prop, int32_t * const content_width);

/**
 * @brief Calculates the dynamic height of an LVGL object based on its style and parent.
 * @param obj Pointer to the LVGL object whose height is being calculated.
 * @param prop LV_STYLE_HEIGHT, LV_STYLE_MIN_HEIGHT, or LV_STYLE_MAX_HEIGHT
 ...
 */
int32_t calc_dynamic_height(lv_obj_t * obj, lv_style_prop_t prop, int32_t * const content_height);
