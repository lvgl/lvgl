...
#include "../../libs/tiny_ttf/stb_rect_pack.h"
#include "../../libs/tiny_ttf/stb_truetype_htcw.h"
...
static LV_IMAGE_DSC_CONST void * ttf_get_glyph_bitmap_cb(lv_font_glyph_dsc_t * g_dsc, lv_draw_buf_t * draw_buf);
