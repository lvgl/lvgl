...
typedef struct _lv_svg_render_class {
    void (*set_paint_ref)(struct _lv_svg_render_obj * obj, lv_vector_path_attr_t * dsc,
    ...
    void (*set_attr)(struct _lv_svg_render_obj * obj, lv_vector_path_attr_t * dsc, const lv_svg_attr_t * attr);
