...
class TVG_API Text final : public Paint
{
    public:
         ...
         * @note 0.15
         */
        static Result load(const char * name, const char * data, uint32_t size, const std::string & mimeType = "ttf",
...
class TVG_API Accessor final
{
    public:
        ...
        TVG_DEPRECATED std::unique_ptr<Picture> set(std::unique_ptr<Picture> picture,
