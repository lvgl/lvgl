...
{
	GL_CALL(glUniform4f(uniform_loc, static_cast<float>(color[0]), static_cast<float>(color[1]), static_cast<float>(color[2]),
			    static_cast<float>(color[3])));
}

lv_result_t setup_restore_primary_output(lv_gltf_view_desc_t *view_desc, gl_renwin_state_t state, uint32_t texture_w, uint32_t texture_h,
