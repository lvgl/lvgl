...
uint32_t lv_gl_shader_manager_select_shader(lv_gl_shader_manager_t *shader, const char *shader_identifier,
					    lv_gl_shader_t *permutations, size_t permutations_len);
lv_gl_shader_program_t *lv_gl_shader_manager_get_program(lv_gl_shader_manager_t *manager, uint32_t fragment_shader_hash,
