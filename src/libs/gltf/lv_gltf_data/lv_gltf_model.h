 ...
 * or embedded as base64-encoded data within the glTF file.
 *
 * @param data Pointer to the glTF model data structure
 ...
 *
 * Meshes contain the geometric data for 3D objects, including vertex positions, normals,
