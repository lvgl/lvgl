...
#elif LV_USE_DRAW_BUF_CONVERT_ASM == LV_DRAW_BUF_CONVERT_ASM_HELIUM
    #include "helium/lv_draw_buf_convert_helium.h"
#elif LV_USE_DRAW_BUF_CONVERT_ASM == LV_DRAW_BUF_CONVERT_ASM_CUSTOM
    #include LV_DRAW_BUF_CONVERT_ASM_CUSTOM_INCLUDE
#endif
...
#ifndef LV_DRAW_CONVERT_PREMULTIFY_INDEXED
    #define LV_DRAW_CONVERT_PREMULTIFY_INDEXED(...)                         LV_RESULT_INVALID
#endif

#ifndef LV_DRAW_CONVERT_PREMULTIFY_ARGB8888
    #define LV_DRAW_CONVERT_PREMULTIFY_ARGB8888(...)                         LV_RESULT_INVALID
#endif

#ifndef LV_DRAW_CONVERT_PREMULTIFY_RGB565A8
    #define LV_DRAW_CONVERT_PREMULTIFY_RGB565A8(...)                         LV_RESULT_INVALID
#endif

#ifndef LV_DRAW_CONVERT_PREMULTIFY_ARGB8565
    #define LV_DRAW_CONVERT_PREMULTIFY_ARGB8565(...)                         LV_RESULT_INVALID
#endif
...
lv_result_t lv_draw_buf_convert_premultiply(lv_draw_buf_t * draw_buf)
{
    ...
    if(LV_COLOR_FORMAT_IS_INDEXED(cf)) {
        if(LV_RESULT_INVALID == LV_DRAW_CONVERT_PREMULTIFY_INDEXED(draw_buf)) {
        ...
        if(LV_RESULT_INVALID == LV_DRAW_CONVERT_PREMULTIFY_ARGB8888(draw_buf)) {
        ...
        if(LV_RESULT_INVALID == LV_DRAW_CONVERT_PREMULTIFY_RGB565A8(draw_buf)) {
            uint32_t h = draw_buf->header.h;
            uint32_t w = draw_buf->header.w;
            uint32_t stride = draw_buf->header.stride;
        ...
        if(LV_RESULT_INVALID == LV_DRAW_CONVERT_PREMULTIFY_ARGB8565(draw_buf)) {
            uint32_t h = draw_buf->header.h;
            uint32_t w = draw_buf->header.w;
            uint32_t stride = draw_buf->header.stride;
            uint8_t * line = (uint8_t *)draw_buf->data;
