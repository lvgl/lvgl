...
#define LV_DRAW_CONVERT_PREMULTIFY_INDEXED(buf) \
    _lv_draw_buf_convert_premultiply_indexed_neon(buf)
#endif

#ifndef LV_DRAW_CONVERT_PREMULTIFY_ARGB8888
#define LV_DRAW_CONVERT_PREMULTIFY_ARGB8888(buf) \
...
/**
 * Convert argb8888draw_buf to premultiplied format with neon specific optimizations
 * @param buf     pointer to a draw buf
 */
