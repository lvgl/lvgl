                                          ...
                                          lv_draw_fill_dsc_t * fill_draw_dsc, const lv_area_t * fill_area)
{
    ...
    d2_framebuffer(unit->d2_handle,
                   unit->base_unit.target_layer->draw_buf->data,
                   (d2_s32)unit->base_unit.target_layer->draw_buf->header.stride / lv_color_format_get_size(unit->base_unit.target_layer->color_format),
