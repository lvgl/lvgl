                      ...
                      const lv_area_t * coords)
{
    ...
    memset(&fill_cfg, 0, sizeof(fill_cfg));

    fill_cfg.fill_argb_color.val = lv_color_to_u32(dsc->color);
    fill_cfg.out.block_offset_x = 0;
    fill_cfg.out.block_offset_y = 0;
    ...
    fill_cfg.out.pic_w          = lv_area_get_width(coords);
    fill_cfg.out.pic_h          = lv_area_get_height(coords);
