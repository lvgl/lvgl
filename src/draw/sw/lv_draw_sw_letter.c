...
#if LV_DRAW_SW_COMPLEX && LV_DRAW_SW_FONT_SUBPX
...
#endif /*LV_DRAW_SW_COMPLEX && LV_DRAW_SW_FONT_SUBPX*/
                              ...
                              lv_font_glyph_dsc_t * g, const uint8_t * map_p)
{
    ...
    lv_color_t * color_buf = lv_mem_alloc(mask_buf_size * sizeof(lv_color_t));
