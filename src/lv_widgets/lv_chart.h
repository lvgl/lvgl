...
enum {
    ...
    LV_CHART_CURSOR_DIRECTION_PRIMARY_HOR    = 0x01,
    LV_CHART_CURSOR_DIRECTION_PRIMARY_VER    = 0x02,
    LV_CHART_CURSOR_DIRECTION_SECONDARY_HOR    = 0x04,
    LV_CHART_CURSOR_DIRECTION_SECONDARY_VER    = 0x08
};
