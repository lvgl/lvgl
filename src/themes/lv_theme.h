<<<<<<< HEAD
#warning Include public headers from the `src` folder is deprecated. This file will be removed soon. To ensure your application keeps working, you can choose to include the new header in <include/lvgl/themes/lv_theme.h> or include the main header file <include/lvgl/lvgl.h>
...
#endif /*LV_THEME_H*/
>>>>>>> e2d6125b4 (test(theme): add getter and setter for theme user_data)
