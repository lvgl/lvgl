...
/*1: Enable Metrics component*/
#ifndef LV_USE_METRICS
    #ifdef _LV_KCONFIG_PRESENT
        #ifdef CONFIG_LV_USE_METRICS
            #define LV_USE_METRICS CONFIG_LV_USE_METRICS
        #else
            #define LV_USE_METRICS 0
        #endif
    #else
        #define LV_USE_METRICS 1
    #endif
#endif
