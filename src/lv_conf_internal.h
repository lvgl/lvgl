 ...
 * */
        ...
        #define LV_USE_KEYBOARD   1
        ...
        #ifdef CONFIG_LV_KEYBOARD_CTRL_BUTTON_MODE_TEXT_LOWER
            #define LV_KEYBOARD_CTRL_BUTTON_MODE_TEXT_LOWER CONFIG_LV_KEYBOARD_CTRL_BUTTON_MODE_TEXT_LOWER
        #else
            #define LV_KEYBOARD_CTRL_BUTTON_MODE_TEXT_LOWER     "abc"
        #endif
    #endif
    #ifndef LV_KEYBOARD_CTRL_BUTTON_MODE_TEXT_UPPER
        #ifdef CONFIG_LV_KEYBOARD_CTRL_BUTTON_MODE_TEXT_UPPER
            #define LV_KEYBOARD_CTRL_BUTTON_MODE_TEXT_UPPER CONFIG_LV_KEYBOARD_CTRL_BUTTON_MODE_TEXT_UPPER
        #else
            #define LV_KEYBOARD_CTRL_BUTTON_MODE_TEXT_UPPER     "ABC"
        #endif
    #endif
    #ifndef LV_KEYBOARD_CTRL_BUTTON_MODE_SPECIAL
        #ifdef CONFIG_LV_KEYBOARD_CTRL_BUTTON_MODE_SPECIAL
            #define LV_KEYBOARD_CTRL_BUTTON_MODE_SPECIAL CONFIG_LV_KEYBOARD_CTRL_BUTTON_MODE_SPECIAL
        #else
            ...
            #ifdef CONFIG_LV_KEYBOARD_CTRL_BUTTON_MODE_TEXT_ARABIC
                #define LV_KEYBOARD_CTRL_BUTTON_MODE_TEXT_ARABIC CONFIG_LV_KEYBOARD_CTRL_BUTTON_MODE_TEXT_ARABIC
            #else
