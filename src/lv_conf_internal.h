 ...
 */
#ifndef LV_VG_LITE_LINEAER_GRAD_CACHE_SIZE
    #ifdef CONFIG_LV_VG_LITE_LINEAER_GRAD_CACHE_SIZE
        #define LV_VG_LITE_LINEAER_GRAD_CACHE_SIZE CONFIG_LV_VG_LITE_LINEAER_GRAD_CACHE_SIZE
    #else
        #define LV_VG_LITE_LINEAER_GRAD_CACHE_SIZE 32
    #endif
#endif
 ...
 */
#ifndef LV_VG_LITE_RADIAL_GRAD_CACHE_SIZE
    #ifdef CONFIG_LV_VG_LITE_RADIAL_GRAD_CACHE_SIZE
        #define LV_VG_LITE_RADIAL_GRAD_CACHE_SIZE CONFIG_LV_VG_LITE_RADIAL_GRAD_CACHE_SIZE
    #else
        #define LV_VG_LITE_RADIAL_GRAD_CACHE_SIZE 32
    #endif
#endif
