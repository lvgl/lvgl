...
static bool init_cb(lv_cache_t * cache)
{
    ...
    lv_lru_rb_set_compare_cb(lru, (lv_rb_compare_t)lru->cache.ops.compare_cb, NULL);
    lv_lru_rb_set_free_cb(lru, lru->cache.ops.free_cb, NULL);
