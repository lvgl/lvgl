 ...
 * @param user_data     A user data pointer that will be passed to the free callback. @nullable
 */
 ...
 * @param user_data     A user data pointer that will be passed to the create callback. @nullable
 ...
 * @param user_data     A user data pointer. @nullable
 */
