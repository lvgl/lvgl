...
typedef enum {
    ...
    LV_EVENT_PRESS_LOST,          /**< Widget is still being pressed but slid cursor/finger off of the Widget */
    LV_EVENT_SHORT_CLICKED,       /**< Widget was pressed for a short period of time, then released it. Not called if scrolled.*/
    ...
    LV_EVENT_FOCUSED,             /**< Widget is focused*/
    LV_EVENT_DEFOCUSED,           /**< Widget's focus is removed */
    LV_EVENT_LEAVE,               /**< Widget's focus is removed but is still selected*/
