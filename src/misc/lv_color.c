...
{
    static const lv_color_t colors[][4] = {
        {LV_COLOR_MAKE(0xFF, 0x8A, 0x80), LV_COLOR_MAKE(0xFF, 0x52, 0x52), LV_COLOR_MAKE(0xFF, 0x17, 0x44), LV_COLOR_MAKE(0xD5, 0x00, 0x00)},
        {LV_COLOR_MAKE(0xFF, 0x80, 0xAB), LV_COLOR_MAKE(0xFF, 0x40, 0x81), LV_COLOR_MAKE(0xF5, 0x00, 0x57), LV_COLOR_MAKE(0xC5, 0x11, 0x62)},
        {LV_COLOR_MAKE(0xEA, 0x80, 0xFC), LV_COLOR_MAKE(0xE0, 0x40, 0xFB), LV_COLOR_MAKE(0xD5, 0x00, 0xF9), LV_COLOR_MAKE(0xAA, 0x00, 0xFF)},
        {LV_COLOR_MAKE(0xB3, 0x88, 0xFF), LV_COLOR_MAKE(0x7C, 0x4D, 0xFF), LV_COLOR_MAKE(0x65, 0x1F, 0xFF), LV_COLOR_MAKE(0x62, 0x00, 0xEA)},
        {LV_COLOR_MAKE(0x8C, 0x9E, 0xFF), LV_COLOR_MAKE(0x53, 0x6D, 0xFE), LV_COLOR_MAKE(0x3D, 0x5A, 0xFE), LV_COLOR_MAKE(0x30, 0x4F, 0xFE)},
        {LV_COLOR_MAKE(0x82, 0xB1, 0xFF), LV_COLOR_MAKE(0x44, 0x8A, 0xFF), LV_COLOR_MAKE(0x29, 0x79, 0xFF), LV_COLOR_MAKE(0x29, 0x62, 0xFF)},
        {LV_COLOR_MAKE(0x80, 0xD8, 0xFF), LV_COLOR_MAKE(0x40, 0xC4, 0xFF), LV_COLOR_MAKE(0x00, 0xB0, 0xFF), LV_COLOR_MAKE(0x00, 0x91, 0xEA)},
        {LV_COLOR_MAKE(0x84, 0xFF, 0xFF), LV_COLOR_MAKE(0x18, 0xFF, 0xFF), LV_COLOR_MAKE(0x00, 0xE5, 0xFF), LV_COLOR_MAKE(0x00, 0xB8, 0xD4)},
        {LV_COLOR_MAKE(0xA7, 0xFF, 0xEB), LV_COLOR_MAKE(0x64, 0xFF, 0xDA), LV_COLOR_MAKE(0x1D, 0xE9, 0xB6), LV_COLOR_MAKE(0x00, 0xBF, 0xA5)},
        {LV_COLOR_MAKE(0xB9, 0xF6, 0xCA), LV_COLOR_MAKE(0x69, 0xF0, 0xAE), LV_COLOR_MAKE(0x00, 0xE6, 0x76), LV_COLOR_MAKE(0x00, 0xC8, 0x53)},
        {LV_COLOR_MAKE(0xCC, 0xFF, 0x90), LV_COLOR_MAKE(0xB2, 0xFF, 0x59), LV_COLOR_MAKE(0x76, 0xFF, 0x3), LV_COLOR_MAKE(0x64, 0xDD, 0x17)},
        {LV_COLOR_MAKE(0xF4, 0xFF, 0x81), LV_COLOR_MAKE(0xEE, 0xFF, 0x41), LV_COLOR_MAKE(0xC6, 0xFF, 0x00), LV_COLOR_MAKE(0xAE, 0xEA, 0x00)},
        {LV_COLOR_MAKE(0xFF, 0xFF, 0x8D), LV_COLOR_MAKE(0xFF, 0xFF, 0x00), LV_COLOR_MAKE(0xFF, 0xEA, 0x00), LV_COLOR_MAKE(0xFF, 0xD6, 0x00)},
        {LV_COLOR_MAKE(0xFF, 0xE5, 0x7F), LV_COLOR_MAKE(0xFF, 0xD7, 0x40), LV_COLOR_MAKE(0xFF, 0xC4, 0x00), LV_COLOR_MAKE(0xFF, 0xAB, 0x00)},
        {LV_COLOR_MAKE(0xFF, 0xD1, 0x80), LV_COLOR_MAKE(0xFF, 0xAB, 0x40), LV_COLOR_MAKE(0xFF, 0x91, 0x00), LV_COLOR_MAKE(0xFF, 0x6D, 0x00)},
        {LV_COLOR_MAKE(0xFF, 0x9E, 0x80), LV_COLOR_MAKE(0xFF, 0x6E, 0x40), LV_COLOR_MAKE(0xFF, 0x3D, 0x00), LV_COLOR_MAKE(0xDD, 0x2C, 0x00)},
    };

    if(p > LV_PALETTE_DEEP_ORANGE) { // No accent colors for browns and greys
        LV_LOG_WARN("Invalid palette: %d", p);
        return lv_color_black();
    }
