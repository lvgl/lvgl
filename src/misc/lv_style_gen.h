...
{
   lv_style_value_t v = {0};
   const lv_color_filter_dsc_t * * v2 = (const lv_color_filter_dsc_t * *) &v;
   *v2 = value;
...
{
   lv_style_value_t v = {0};
   const lv_style_transition_dsc_t * * v2 = (const lv_style_transition_dsc_t * *) &v;
   *v2 = value;
...
{
   lv_style_value_t v = {0};
   lv_blend_mode_t * v2 = (lv_blend_mode_t *) &v;
   *v2 = value;
...
{
   lv_style_value_t v = {0};
   lv_base_dir_t * v2 = (lv_base_dir_t *) &v;
   *v2 = value;
...
{
   lv_style_value_t v = {0};
   lv_grad_dir_t * v2 = (lv_grad_dir_t *) &v;
   *v2 = value;
...
{
   lv_style_value_t v = {0};
   lv_border_side_t * v2 = (lv_border_side_t *) &v;
   *v2 = value;
...
{
   lv_style_value_t v = {0};
   const lv_font_t * * v2 = (const lv_font_t * *) &v;
   *v2 = value;
...
{
   lv_style_value_t v = {0};
   lv_text_decor_t * v2 = (lv_text_decor_t *) &v;
   *v2 = value;
...
{
   lv_style_value_t v = {0};
   lv_text_align_t * v2 = (lv_text_align_t *) &v;
   *v2 = value;
