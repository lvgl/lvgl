...
/**
 * Helper macro to iterator on each @ref lv_map_entry_t of a @ref lv_map_t.
 *
...
/**
 * Helper macro to iterator on each @ref lv_map_entry_t of a @ref lv_map_t in reverse order.
 *
...
typedef struct _lv_link_t {
    ...
    struct _lv_link_t * next; /**< Pointer to the next node ino the doubly linked list */
} lv_link_t;
...
typedef struct _lv_map_t {
    const lv_map_class_t * class_p; /**< The pointer to the class this map is instanciating */
 ...
 * their own allocator.
 * @param class_p pointer to the @ref lv_map_class_t class the map will be instanciated
 *                from.
 ...
 * @ref lv_map_init().
 * @param class_p pointer to the @ref lv_map_class_t class the @ref lv_map_t is instanciated from.
 ...
 * @param entry a pointer to a map entry.
 * @param value a pointer to a valid valid for the map class.
 */
