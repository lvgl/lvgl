...
LV_ATTRIBUTE_EXTERN_DATA const lv_style_prop_t _lv_style_const_prop_id_FLEX_FLOW =
    LV_STYLE_FLEX_FLOW;
...
LV_ATTRIBUTE_EXTERN_DATA const lv_style_prop_t _lv_style_const_prop_id_FLEX_MAIN_PLACE =
...
LV_ATTRIBUTE_EXTERN_DATA const lv_style_prop_t _lv_style_const_prop_id_FLEX_CROSS_PLACE =
...
LV_ATTRIBUTE_EXTERN_DATA const lv_style_prop_t _lv_style_const_prop_id_FLEX_TRACK_PLACE =
...
LV_ATTRIBUTE_EXTERN_DATA const lv_style_prop_t _lv_style_const_prop_id_FLEX_GROW =
    LV_STYLE_FLEX_GROW;
#endif /*LV_USE_FLEX*/
...
LV_ATTRIBUTE_EXTERN_DATA const lv_style_prop_t _lv_style_const_prop_id_GRID_COLUMN_DSC_ARRAY =
...
LV_ATTRIBUTE_EXTERN_DATA const lv_style_prop_t _lv_style_const_prop_id_GRID_COLUMN_ALIGN =
...
LV_ATTRIBUTE_EXTERN_DATA const lv_style_prop_t _lv_style_const_prop_id_GRID_ROW_DSC_ARRAY =
...
LV_ATTRIBUTE_EXTERN_DATA const lv_style_prop_t _lv_style_const_prop_id_GRID_ROW_ALIGN =
...
LV_ATTRIBUTE_EXTERN_DATA const lv_style_prop_t _lv_style_const_prop_id_GRID_CELL_COLUMN_POS =
...
LV_ATTRIBUTE_EXTERN_DATA const lv_style_prop_t _lv_style_const_prop_id_GRID_CELL_X_ALIGN =
...
LV_ATTRIBUTE_EXTERN_DATA const lv_style_prop_t _lv_style_const_prop_id_GRID_CELL_COLUMN_SPAN =
...
LV_ATTRIBUTE_EXTERN_DATA const lv_style_prop_t _lv_style_const_prop_id_GRID_CELL_ROW_POS =
...
LV_ATTRIBUTE_EXTERN_DATA const lv_style_prop_t _lv_style_const_prop_id_GRID_CELL_Y_ALIGN =
...
LV_ATTRIBUTE_EXTERN_DATA const lv_style_prop_t _lv_style_const_prop_id_GRID_CELL_ROW_SPAN =
