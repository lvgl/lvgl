...
enum _lv_style_id_t {
    ...
    LV_STYLE_IMAGE_OPA = 10 * 8,
    LV_STYLE_SHADOW_OPA,
    LV_STYLE_LINE_OPA,
    LV_STYLE_ARC_OPA,
    LV_STYLE_TEXT_OPA,

    LV_STYLE_SHADOW_COLOR = 11 * 8,
    LV_STYLE_IMAGE_RECOLOR,
    LV_STYLE_LINE_COLOR,
    LV_STYLE_ARC_COLOR,
    LV_STYLE_TEXT_COLOR,

    LV_STYLE_ARC_IMAGE_SRC = 12 * 8,
    ...
    /*Blur*/
    LV_STYLE_BLUR_RADIUS = 17 * 8,
    LV_STYLE_BLUR_BACKDROP,
    LV_STYLE_BLUR_QUALITY,

    /*Drop shadow*/
    LV_STYLE_DROP_SHADOW_RADIUS = 18 * 8,
    ...
    /*Scale and transform*/
    LV_STYLE_TRANSFORM_SCALE_X = 19 * 8,
    ...
    LV_STYLE_GRID_COLUMN_ALIGN = 21 * 8,
