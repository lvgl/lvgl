 ...
 * @param destructor Callback function for cleaning up data when display is deleted.
 *                   Receives data as parameter. NULL means no cleanup required.
 */
void lv_display_set_external_data(lv_display_t * disp, void * data, void (* destructor)(void * data));
#endif
