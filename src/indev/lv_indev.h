...
typedef lv_key_t (*lv_indev_key_remap_cb_t)(lv_key_t key, void * user_data);
...
/**
 * Set key remapping callback
 * @param indev         pointer to an indev
 * @param remap_cb      remapping function callback. Use NULL to disable callback.
 * @param user_data     pointer to user data
 */
void lv_indev_set_key_remap_cb(lv_indev_t * indev, lv_indev_key_remap_cb_t remap_cb, void * user_data);
