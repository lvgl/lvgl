 ...
 */
typedef void (*lv_st7796_send_cmd_cb_t)(lv_display_t *disp, uint8_t *cmd, size_t cmd_size, uint8_t *param, size_t param_size);
 ...
 */
lv_display_t *lv_st7796_create(uint32_t hor_res, uint32_t ver_res, lv_lcd_flag_t flags, lv_st7796_send_cmd_cb_t send_cmd_cb, lv_st7796_send_cmd_cb_t send_color_cb);
