...
void test_switch_properties(void)
{
    ...
    TEST_ASSERT_EQUAL_INT(lv_obj_get_property(obj, LV_PROPERTY_SWITCH_ORIENTATION).num, LV_SWITCH_ORIENTATION_VERTICAL);
    TEST_ASSERT_EQUAL_INT(lv_switch_get_orientation(obj), LV_SWITCH_ORIENTATION_VERTICAL);

    prop.num = LV_SWITCH_ORIENTATION_HORIZONTAL;
    TEST_ASSERT_TRUE(lv_obj_set_property(obj, &prop) == LV_RESULT_OK);
    TEST_ASSERT_EQUAL_INT(lv_obj_get_property(obj, LV_PROPERTY_SWITCH_ORIENTATION).num, LV_SWITCH_ORIENTATION_HORIZONTAL);
    TEST_ASSERT_EQUAL_INT(lv_switch_get_orientation(obj), LV_SWITCH_ORIENTATION_HORIZONTAL);
