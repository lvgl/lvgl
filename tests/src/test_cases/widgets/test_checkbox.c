...
void test_checkbox_properties(void)
{
    ...
    TEST_ASSERT_EQUAL_STRING(lv_obj_get_property(obj, LV_PROPERTY_CHECKBOX_TEXT).ptr, "Test Checkbox");
    TEST_ASSERT_EQUAL_STRING(lv_checkbox_get_text(obj), "Test Checkbox");
