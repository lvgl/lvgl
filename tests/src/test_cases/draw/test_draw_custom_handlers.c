...
void test_register_custom_handlers(void)
{
    lv_draw_sw_blend_handler_t handler = {
        ...
        .color_blend_handler = NULL,
        .image_blend_handler = NULL,
    };
...
void test_overwrite_custom_handler(void)
{
    lv_draw_sw_blend_handler_t handler = {
        .dest_cf = LV_COLOR_FORMAT_I2,
        .color_blend_handler = (lv_draw_sw_blend_color_handler_t)0xDEADBEEF,
        .image_blend_handler = NULL,
    };

    TEST_ASSERT_TRUE(lv_draw_sw_register_blend_handler(&handler));

    lv_draw_sw_blend_handler_t handler2 = {
        .dest_cf = LV_COLOR_FORMAT_I2,
        .color_blend_handler = (lv_draw_sw_blend_color_handler_t)0xCAFEBABE,
        .image_blend_handler = NULL,
    };
    ...
    TEST_ASSERT_EQUAL_PTR(handler3->color_blend_handler, (lv_draw_sw_blend_color_handler_t)0xCAFEBABE);
}
