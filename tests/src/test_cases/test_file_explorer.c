...
void setUp(void)
{
    ...
    int fd = open("src/test_files/test_file_explorer_folder/video.mp4", O_CREAT);
    close(fd);
    fd = open("src/test_files/test_file_explorer_folder/audio.mp3", O_CREAT);
    close(fd);
    fd = open("src/test_files/test_file_explorer_folder/image.jpg", O_CREAT);
    close(fd);
