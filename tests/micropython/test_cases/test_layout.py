...
#lv_test.assert_greater( 0, lv_testbuttons2[BUTTON_COUNT-1].get_x(), "Grid layout last widget X-coordinate" )
#lv_test.assert_greater( 0, lv_testbuttons2[BUTTON_COUNT-1].get_y(), "Grid layout last widget Y-coordinate" )
