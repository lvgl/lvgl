...
In addition to unit and performance tests, LVGL automatically run the `lv_demo_benchmark` inside the same ARM emulated
environment mentionned in the previous section though CI to prevent unintentional slowdowns.
