...
if(${VERSION_RESULT} GREATER "0")
    message("OUTPUT: ${VERSION_STRING}")
    message("RESULT: ${VERSION_RESULT}")
...
list(GET VERSION_LIST 1 LVGL_VERSION_MINOR)
list(GET VERSION_LIST 2 LVGL_VERSION_PATCH)
list(GET VERSION_LIST 3 LVGL_VERSION_INFO)
