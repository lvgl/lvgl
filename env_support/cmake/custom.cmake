...
if ( LV_USE_KCONFIG )
  ...
  set(PCPP_ADDITIONAL_OPTS "--defs LV_CONF_SKIP LV_CONF_KCONFIG_EXTERNAL_INCLUDE='\"${LV_CONF_KCONFIG_EXTERNAL_INCLUDE}\"'")
else()
  if (LV_CONF_PATH)
    set(PCPP_ADDITIONAL_OPTS "--defs=LV_CONF_PATH=\"${LV_CONF_PATH}\"")
    message("PCPP_ADDITIONAL_OPTS: ${PCPP_ADDITIONAL_OPTS}")
  endif()
endif()
