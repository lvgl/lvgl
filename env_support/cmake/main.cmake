...
if(CONFIG_LV_USE_PRIVATE_API)
    ...
    install(CODE "
        file(READ \"\${CMAKE_INSTALL_PREFIX}/${CMAKE_INSTALL_INCLUDEDIR}/lvgl_private/lvgl_public.h\" content)
        string(REPLACE \"../include/lvgl/lvgl.h\" \"../lvgl/lvgl.h\" content \"\${content}\")
        file(WRITE \"\${CMAKE_INSTALL_PREFIX}/${CMAKE_INSTALL_INCLUDEDIR}/lvgl_private/lvgl_public.h\" \"\${content}\")
    ")
endif()
...
message(STATUS "CMAKE LVGL PUBLIC DEPS: ${LVGL_CMAKE_PUBLIC_DEPS}")
message(STATUS "CMAKE LVGL PRIVATE DEPS: ${LVGL_CMAKE_PRIVATE_DEPS}")
