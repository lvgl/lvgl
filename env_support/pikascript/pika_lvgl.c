...
void pika_lvgl_EVENT___init__(PikaObj* self) {
    obj_setInt(self, "ALL", LV_OBJ_EVENT_ALL);
    obj_setInt(self, "PRESSED", LV_OBJ_EVENT_PRESSED);
    obj_setInt(self, "PRESSING", LV_OBJ_EVENT_PRESSING);
    obj_setInt(self, "PRESS_LOST", LV_OBJ_EVENT_PRESS_LOST);
    obj_setInt(self, "SHORT_CLICKED", LV_OBJ_EVENT_SHORT_CLICKED);
    obj_setInt(self, "LONG_PRESSED", LV_OBJ_EVENT_LONG_PRESSED);
    obj_setInt(self, "LONG_PRESSED_REPEAT", LV_OBJ_EVENT_LONG_PRESSED_REPEAT);
    obj_setInt(self, "CLICKED", LV_OBJ_EVENT_CLICKED);
    obj_setInt(self, "RELEASED", LV_OBJ_EVENT_RELEASED);
    obj_setInt(self, "SCROLL_BEGIN", LV_OBJ_EVENT_SCROLL_BEGIN);
    obj_setInt(self, "SCROLL_END", LV_OBJ_EVENT_SCROLL_END);
    obj_setInt(self, "SCROLL", LV_OBJ_EVENT_SCROLL);
    obj_setInt(self, "GESTURE", LV_OBJ_EVENT_GESTURE);
    obj_setInt(self, "KEY", LV_OBJ_EVENT_KEY);
    obj_setInt(self, "FOCUSED", LV_OBJ_EVENT_FOCUSED);
    obj_setInt(self, "DEFOCUSED", LV_OBJ_EVENT_DEFOCUSED);
    obj_setInt(self, "LEAVE", LV_OBJ_EVENT_LEAVE);
    obj_setInt(self, "HIT_TEST", LV_OBJ_EVENT_HIT_TEST);
    obj_setInt(self, "COVER_CHECK", LV_OBJ_EVENT_COVER_CHECK);
    obj_setInt(self, "REFR_EXT_DRAW_SIZE", LV_OBJ_EVENT_REFR_EXT_DRAW_SIZE);
    obj_setInt(self, "DRAW_MAIN_BEGIN", LV_OBJ_EVENT_DRAW_MAIN_BEGIN);
    obj_setInt(self, "DRAW_MAIN", LV_OBJ_EVENT_DRAW_MAIN);
    obj_setInt(self, "DRAW_MAIN_END", LV_OBJ_EVENT_DRAW_MAIN_END);
    obj_setInt(self, "DRAW_POST_BEGIN", LV_OBJ_EVENT_DRAW_POST_BEGIN);
    obj_setInt(self, "DRAW_POST", LV_OBJ_EVENT_DRAW_POST);
    obj_setInt(self, "DRAW_POST_END", LV_OBJ_EVENT_DRAW_POST_END);
    obj_setInt(self, "DRAW_PART_BEGIN", LV_OBJ_EVENT_DRAW_PART_BEGIN);
    obj_setInt(self, "DRAW_PART_END", LV_OBJ_EVENT_DRAW_PART_END);
    obj_setInt(self, "VALUE_CHANGED", LV_OBJ_EVENT_VALUE_CHANGED);
    obj_setInt(self, "INSERT", LV_OBJ_EVENT_INSERT);
    obj_setInt(self, "REFRESH", LV_OBJ_EVENT_REFRESH);
    obj_setInt(self, "READY", LV_OBJ_EVENT_READY);
    obj_setInt(self, "CANCEL", LV_OBJ_EVENT_CANCEL);
    obj_setInt(self, "DELETE", LV_OBJ_EVENT_DELETE);
    obj_setInt(self, "CHILD_CHANGED", LV_OBJ_EVENT_CHILD_CHANGED);
    obj_setInt(self, "CHILD_CREATED", LV_OBJ_EVENT_CHILD_CREATED);
    obj_setInt(self, "CHILD_DELETED", LV_OBJ_EVENT_CHILD_DELETED);
    obj_setInt(self, "SCREEN_UNLOAD_START", LV_OBJ_EVENT_SCREEN_UNLOAD_START);
    obj_setInt(self, "SCREEN_LOAD_START", LV_OBJ_EVENT_SCREEN_LOAD_START);
    obj_setInt(self, "SCREEN_LOADED", LV_OBJ_EVENT_SCREEN_LOADED);
    obj_setInt(self, "SCREEN_UNLOADED", LV_OBJ_EVENT_SCREEN_UNLOADED);
    obj_setInt(self, "SIZE_CHANGED", LV_OBJ_EVENT_SIZE_CHANGED);
    obj_setInt(self, "STYLE_CHANGED", LV_OBJ_EVENT_STYLE_CHANGED);
    obj_setInt(self, "LAYOUT_CHANGED", LV_OBJ_EVENT_LAYOUT_CHANGED);
    obj_setInt(self, "GET_SELF_SIZE", LV_OBJ_EVENT_GET_SELF_SIZE);
    obj_setInt(self, "PREPROCESS", LV_OBJ_EVENT_PREPROCESS);
}
